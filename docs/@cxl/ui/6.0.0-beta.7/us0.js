...
--cxl-shape-corner-full: 50vh;
	...
	`,css:""};function De(e=""){return`:host ${e} {
...
`}function ji(e){return`box-shadow:var(--cxl-elevation-${e});z-index:${e};`}var _e=p(De()),qi={"./theme-dark.js":()=>import("./theme-dark-F4QQQFSI.js")},tt=[0,4,8,"12",16,24,32,48,64],Oe,Vi,vs;function L(e,t){return e==="xsmall"?`@media(max-width:${Y.breakpoints.small}px){${t}}`:`@media(min-width:${Y.breakpoints[e]}px){${t}}`}function Fo(e){return f(Lt(async()=>e.getBoundingClientRect().width),J(e).map(t=>t.contentRect.width)).map(t=>{let o=Y.breakpoints,r="xsmall";for(let n in o){if(o[n]>t)return r;r=n}return r}).distinctUntilChanged()}function ws(e=""){return Object.entries(Zi).map(([t,o])=>`:host([color=${t}]) ${e}{ ${o} }`).join("")}function re(e,t,o=""){return Wi(e,`
		...
		${ws(o)}
	`)}function Wi(e,t){let o=p(t);return g(e,{persist:Vt,render:r=>o(r)})}function j(e,t){return Wi(e,lr.map(o=>{let r=t(o);return o===0?`:host{--cxl-size:${o}}:host ${r}`:`:host([size="${o}"]){--cxl-size:${o}}:host([size="${o}"]) ${r}`}).join(""))}function Ki(){let e=Oe?document.adoptedStyleSheets.indexOf(Oe):-1;e!==-1&&document.adoptedStyleSheets.splice(e,1)}function ks(e){Oe&&Ki();let t=e.globalCss??"";e.colors&&(t+=`:root{${Ui(e.colors)}}`),t?(Oe=Ye(t),document.adoptedStyleSheets.push(Oe)):Oe=void 0,dt.next({theme:e,stylesheet:Oe,css:t}),No.next(e.name)}var Hi="";function Gi(e){e?e!==Hi&&(typeof e=="string"?import(e):e()).then(t=>ks(t.default),t=>console.error(t)):Oe&&(Ki(),dt.next(void 0),No.next("")),Hi=e}function Ss(e){let t;return dt.tap(o=>{let r=o?.theme.override?.[e.tagName];r?t?t.replace(r).catch(n=>console.error(n)):e.shadowRoot?.adoptedStyleSheets.push(t??=Ye(r)):t&&t.replaceSync("")})}function Ye(e){let t=new CSSStyleSheet;return e&&t.replaceSync(e),t}function Ro(e,t=""){let o=Ye(t);return N(e).adoptedStyleSheets.push(o),o}function p(e){let t;return o=>{let r=N(o);if(r.adoptedStyleSheets.push(t??=Ye(e)),!o[Eo])return Y.css&&r.adoptedStyleSheets.unshift(vs??=Ye(Y.css)),o[Eo]=!0,Ss(o)}}var cr=["background","primary","primary-container","primary-fixed-dim","primary-fixed","secondary","secondary-container","tertiary","tertiary-container","surface","surface-container","surface-container-low","surface-container-lowest","surface-container-highest","surface-container-high","error","error-container","success","success-container","warning","warning-container","inverse-surface","inverse-primary"],rp=[...cr,"inherit"];function ar(e,t="surface"){return`--cxl-color-${t}: var(--cxl-color--${e});
...
`);function mr(e){return m(e,"disabled").switchMap(t=>t?v:yo(e).tap(o=>{o.stopPropagation(),e.click()}))}function ce(e){return f(mr(e),ve(e))}var ht=class extends d{disabled=!1;touched=!1};s(ht,{init:[x("disabled"),x("touched")],augment:[k("button"),ce]});var we=class extends ht{size;color;variant};s(we,{tagName:"c-button",init:[j("size",e=>`{
		...
		}`),re("color","primary"),x("variant")],augment:[...ot,Fs,Q,y]});var je;function ia(e){if(e==="0s"||e==="auto")return;let t=e.endsWith("ms")?1:1e3;return parseFloat(e)*t}function Rs(e){return e==="infinite"?1/0:+e}function Ds(e){if(ta(e))return{animation:e};let t=e.startsWith("auto ");t&&(e="0s "+e.slice(5));let o={},r;e=e.replace(/stagger:(\d+)|composition:(\w+)/g,(c,l,u)=>(l&&(r=+l),u&&(o.composite=u),"")),je??=document.createElement("style").style,je.animation=e,o.fill=je.animationFillMode;let n=o.fill==="forwards"||o.fill==="both",i=t?void 0:ia(je.animationDuration);i!==void 0&&(o.duration=i);let a=ia(je.animationDelay);return a!==void 0&&(o.delay=a),je.animationIterationCount&&(o.iterations=Rs(je.animationIterationCount)),{animation:je.animationName,keep:n,stagger:r,options:o}}function zs(e){return typeof e=="string"&&(e=e.split(",").map(t=>Ds(t.trim()))),e}function Ot(e,t,o,r){let n=r?`motion-${r}-on`:"motion-on",i=zs(o);return e.setAttribute(n,""),f(...i.map(a=>Ht({target:t,...a}))).finalize(()=>e.removeAttribute(n))}var bt=p(":host(:not([open],[motion-out-on])){display:none}");function ze(e,t=()=>e,o=!1){let r=_(()=>M(t("in"))),n=_(()=>M(t("out"))),i=_(()=>e.duration!==void 0&&e.duration!==1/0?Me(e.duration).map(()=>e.open=!1):v).log();return f(G(e,"toggle.close").tap(()=>e.open=!1).ignoreElements(),B(m(e,"motion-in").map(a=>(a?r.mergeMap(c=>Ot(e,c,a,"in")):r).mergeMap(()=>i)),m(e,"motion-out").map(a=>(a?n.switchMap(c=>Ot(e,c,a,"out")):n).finalize(()=>{e.open||e.dispatchEvent(new Event("close"))}))).switchMap(([a,c])=>z(e,"open").switchMap(l=>{if(e.popover!=="auto"){let u=l?"open":"closed";e.dispatchEvent(new ToggleEvent("toggle",{oldState:l?"closed":"open",newState:u}))}return l?o?Ne(c,a):a:o?Ne(c,a):c})))}var ke=class extends d{open=!1;duration;"motion-in";"motion-out"};s(ke,{init:[g("motion-in"),g("motion-out"),le("duration"),x("open")]});var Yt=class extends ke{};s(Yt,{tagName:"c-toggle-target",augment:[p(`
:host{display:contents}
`),e=>{let t=h("slot"),o=h("slot",{name:"off"});return(e.open?o:t).style.display="none",N(e).append(t,o),ze(e,r=>{t.style.display=o.style.display="none";let n=e.open?r==="in"?t:o:r==="in"?o:t;return n.style.display="",n.assignedElements()},!0)}]});var dr={get(e){try{return localStorage.getItem(e)??void 0}catch(t){console.error(t)}return""},set(e,t){try{localStorage.setItem(e,t)}catch(o){console.error(o)}}};function nf(e){return(t,o)=>t[e]>o[e]?1:t[e]<o[e]?-1:0}function Ie(e,t){if(t==="_parent")return e.parentElement||void 0;if(t==="_next")return e.nextElementSibling||void 0;if(typeof t!="string")return t??void 0;let o,r=e.getRootNode();return r instanceof ShadowRoot&&(o=r.getElementById(t),o)?o:e.ownerDocument.getElementById(t)??void 0}function Io(e,t){return m(e,t).map(o=>Ie(e,o))}var gr=class{currentPopupContainer;currentPopup;currentModal;currentTooltip;popupContainer=document.body;toggle(t){t.element.parentElement!==this.popupContainer?this.popupOpened(t):t.close()}popupOpened(t){this.currentPopup&&t.element!==this.currentPopup.element&&this.currentPopup.close(),this.currentPopup=t}openModal(t){this.currentModal&&t.element!==this.currentModal.element&&this.currentModal.close(),t.element.parentNode||this.popupContainer.append(t.element),t.element.open||t.element.showModal(),this.currentModal=t}closeModal(){this.currentModal?.close(),this.modalClosed()}modalClosed(){this.currentModal=void 0}tooltipOpened(t){this.currentTooltip&&this.currentTooltip!==t&&this.currentTooltip.remove(),this.currentTooltip=t}close(){this.currentPopup?.close()}},te=new gr;var Po=(e,t,o=e)=>D(e).tap(()=>U(o,"toggle.close",t)),gf=(e,t,o=e)=>D(e).tap(()=>U(o,"toggle.open",t));function Lo(e){let t=e.target;if(t)return typeof t=="string"?t.split(" ").flatMap(o=>{let r=Ie(e,o);return r?[r]:[]}):Array.isArray(t)?t:[t]}function hr(e,t,o,r,n=b(e,"click").map(()=>!o())){return f(r,n).switchMap(i=>{let a=t();return a?xe(a.map(c=>({target:c,open:i}))):v})}function rt(e,t=e){function o(i,a){return[m(e,"open").switchMap(c=>(i.parentNode||te.popupContainer.append(i),i.open=c,c&&i instanceof d?z(i,"open").map(l=>{e.open&&l===!1&&(e.open=!1)}):v)),He(i).tap(c=>{let l=i.getAttribute("role");(l==="menu"||l==="listbox"||l==="tree"||l==="grid"||l==="dialog")&&(a.ariaHasPopup=l),a.getRootNode()===i.getRootNode()&&a.setAttribute("aria-controls",c)})]}let r=B(m(e,"trigger"),m(e,"target")).switchMap(([i])=>{let a=Lo(e),c=a?f(...a.flatMap(l=>o(l,e))).ignoreElements():v;return f(i==="hover"?B(rr(t),a?f(...a.map(l=>rr(l))):v).map(l=>!!l.find(u=>!!u)).debounceTime(250):i==="checked"?b(t,"change").map(l=>l.target&&"checked"in l.target?!!l.target.checked:!1):b(t,"click").map(()=>!e.open),c)}),n;return Ci().switchMap(()=>hr(t,()=>Lo(e),()=>e.open,m(e,"open"),r).filter(i=>{let{open:a,target:c}=i;if(e.open!==a){if(a)n=ye(e)?.activeElement,c.trigger=e;else if(c.trigger&&c.trigger!==e)return i.open=!0,c.trigger=e,!0;return e.open=a,!1}if(!a&&c.trigger===e){let l=document.activeElement;(l===document.body||l===document.documentElement)&&n?.focus()}return!0}))}var qe=class extends d{open=!1;target;trigger};s(qe,{init:[g("target"),g("trigger"),x("open")],augment:[e=>rt(e).raf(({target:t,open:o})=>t.open=o)]});var xr=class extends qe{};s(xr,{tagName:"c-toggle",augment:[V,y]});var _t=class extends ke{};s(_t,{tagName:"c-details",augment:[p(`
:host { display: block; }
:host(:not([open],[motion-out-on])) #body {display:none}
		`),e=>{let t=h("slot",{id:"body"}),o=h("slot",{id:"header",name:"header"});return N(e).append(o,t),f(hr(o,()=>[e],()=>e.open,m(e,"open")).raf(({open:r})=>{e.open=r}),ze(e,()=>t))}]});var Xt=class extends _t{constructor(){super(),this["motion-in"]="openY",this["motion-out"]="closeY"}};s(Xt,{tagName:"c-accordion-panel",augment:[k("region"),p(`
:host {
	background-color: var(--cxl-color-surface);
	color: var(--cxl-color-on-surface);
...
:host([disabled]) {
	color: color-mix(in srgb, var(--cxl-color--on-surface) 38%, transparent);
		...
		`),H,e=>{let t=new ee;t.name="keyboard_arrow_down",t.id="icon",t.role="none",e.slot||="header",N(e).append(t,document.createElement("slot"));let o=e.parentElement;return o instanceof Xt?f(He(o).tap(r=>e.setAttribute("aria-controls",r)),m(o,"open").tap(r=>{t.classList.toggle("open",r),e.ariaExpanded=String(r)})):v},ce]});var Ut=class extends d{outline=!1;color};s(Ut,{tagName:"c-alert",init:[x("outline"),re("color","inverse-surface")],augment:[k("alert"),p(`
:host {
	box-sizing: border-box;
	display: flex;
	align-items: center;
...
:host(:not([selected])) { padding: 4px 32px; }
		`),_e,Q,()=>h(ee,{id:"check",name:"check"}),y]});var _r=class extends wt{optionView=Yo;size};s(_r,{tagName:"c-button-segmented",init:[j("size",e=>`{
			font-size: ${14+e*1}px;
			min-height: ${40+e*8}px;
		}`)],augment:[k("listbox"),p(`
:host {
...
`);function Cl(e){return f(ae("list",e),m(e,"selected").tap(t=>e.ariaSelected=String(t)))}function Wr(e){return f(mr(e),ve(e,e,-1),Cl(e))}var Ce=class extends d{disabled=!1;touched=!1;selected=!1};s(Ce,{init:[x("disabled"),x("touched"),x("selected")],augment:[Wr]});var qr=class extends Ce{size};s(qr,{tagName:"c-item",init:[j("size",e=>`{min-height:${56+e*8}px}`)],augment:[El,H,_e,k("option"),y,Q]});var Kr=class extends Jt{disabled=!1;touched=!1;selected=!1};s(Kr,{tagName:"c-card-item",init:[x("disabled"),x("touched"),x("selected")],augment:[k("option"),...ot,p(`
...
:host([center]) {
  ...
  align-items: center;
	...
	`),e=>b(e,"keydown").tap(t=>t.stopPropagation()),y]});var to=class extends ke{};s(to,{tagName:"c-toggle-panel",augment:[y,bt,ze]});var Vl=p(`
#drawer {
	box-sizing: border-box;
    background-color: var(--cxl-color-surface);
    color: var(--cxl-color-on-surface);
...
:host {
	...
	`),y,e=>{let t=Ro(e);return Et(e).switchMap(o=>f(J(o),m(o,"value"),m(o,"inputValue")).raf(()=>{let r=o.inputValue??o.value,n=r===void 0||r==="";t.replaceSync(`:host{top:${o.offsetTop}px;left:${o.offsetLeft}px;width:${o.offsetWidth}px;height:${o.offsetHeight}px;${n?"":"display:none;"}`)}))}]});function Da(e,t){return e?typeof e=="string"?(t.setAttribute("aria-label",e),v):He(e).tap(o=>{e.textContent&&t.setAttribute("aria-labelledby",o)}).finalize(()=>{t.removeAttribute("aria-labelledby")}):v}var Cn=class extends d{};s(Cn,{tagName:"c-label",augment:[p(`
:host {
	display: inline-block;
...
:host([open]) .icon { rotate: 180deg; }
		`),e=>rt(e).raf(({target:t,open:o})=>t.open=o),e=>{let t=h(ee,{className:"icon"});return N(e).append(t),f(m(e,"icon").tap(o=>t.name=o))}]});var so=class extends qe{icon="more_vert";motion};s(so,{tagName:"c-toggle-icon",init:[g("icon")],augment:[e=>{let t;return f(m(e,"icon").raf(o=>{if(!o)return t?.remove();t=xt(o),N(e).append(t)}),m(e,"open").raf(()=>{t&&e.motion&&ne({target:t,animation:e.motion,options:{direction:e.open?"normal":"reverse",fill:"both"}})}))}]});var Tn=class extends Ce{icon="arrow_right";open=!1;target;size};s(Tn,{tagName:"c-nav-tree-item",init:[g("icon"),g("target"),x("open"),j("size",e=>`{min-height:${56+e*8}px}`)],augment:[k("treeitem"),...ao,p(`
...
slot[name=action] { margin-inline-start: auto; display: block; }
	`),()=>h("slot",{name:"action"}),e=>m(e,"open").tap(t=>{t&&!e.static&&(e.popover="manual",e.showPopover())}),bt,ze,e=>b(e,"close").tap(()=>e.remove())]});var lo=class extends d{queue=[];notify(t){let o;return typeof t=="string"?o=h(Tt,void 0,t):t instanceof HTMLElement?o=t:o=h(Tt,t,t.content),new Promise(r=>{this.queue.push([o,r]),this.queue.length===1&&this.queue[0]&&this.notifyNext(this.queue[0])})}notifyNext([t,o]){let r=()=>{this.queue.shift(),t.removeEventListener("close",r),o(),this.queue[0]&&this.notifyNext(this.queue[0])};this.shadowRoot?.append(t),t.addEventListener("close",r),t.open=!0}};s(lo,{tagName:"c-snackbar-container",augment:[p(`
:host {
	position:relative; width: 100%; height: 0;
	display: flex; text-align:center; align-items: end;
	overflow: visible;
}`)]});var za;function sv(e){let t;return typeof e=="string"?e={content:e}:e instanceof HTMLElement||(t=e.container),t||(t=za??=new lo,t.parentNode||document.body.appendChild(t)),t.notify(e)}function lv(e){za=e}function Ia(e){return f(m(e,"selected").pipe(Ii(e,"selected")),ae("selectable",e),D(e).tap(()=>U(e,"selectable.action",e)))}var zn=class extends d{value;view;selected=!1;hidden=!1;focused=!1;rendered;focus(){this.rendered?.focus()}};s(zn,{tagName:"c-option",init:[g("value"),O("view"),x("selected"),x("hidden"),x("focused")],augment:[k("option"),p(":host{display:contents} :host([hidden]){display:none;}"),vt,Ia,e=>{let t;return f(m(e,"view").switchMap(o=>o?(t?.remove(),e.rendered=t=new o,t.appendChild(h("slot")),N(e).append(t),f(m(e,"selected").tap(r=>t?.toggleAttribute("selected",r)),m(e,"focused").tap(r=>t?.toggleAttribute("focused",r)))):(e.rendered=t=void 0,v)))}]});var In=class extends d{};s(In,{tagName:"c-page",augment:[Bo,p(`
:host {
	box-sizing:border-box;
	display: flex;
	flex-direction: column;
...
`)]});var $n=class extends d{};s($n,{tagName:"c-router-outlet",init:[],augment:[k("main"),V,Kn,y]});function vc(e){function t(){F=a[w],o(),Dt=!1}function o(){P=Math.min(Math.round(R*Ge),T),de=(R-Math.floor(F/Ge))/(P-F||1),(!isFinite(de)||de<=0)&&(de=.01)}function r(Ae){throw console.error(`Faulty element detected: 
The provided element has an invalid or unmeasurable size. Check that the "${w}" of the element is not zero or negative. Make sure the element is styled properly and any necessary dimensions are set correctly before rendering.`),console.log(Ae),new Error("Rendered element size returned invalid value.")}function n(){Dt&&t();let Ae=Ko=a[S],mi=de*Ae;Rt=mi|0;let Go=Math.max(Math.min(Rt,R-I+1),0),di=Rt+I>R?1/0:F,gi=mi-Rt,Ze=Go,uo=0,xi=0,Qe=0,hi=0,zt=0;for(I=0,Go>0?Qe=-(c(Ze-1,uo++,"pre")[w]+gi*Ge):Qe=-gi*Ge;Ze>=0&&xi<di&&Ze<R;){let Be=c(Ze++,uo++,"on"),Zo=Be[w];Zo<=0&&r(Be),I===0&&(hi=Be[E]),zt=Be[E]+Zo,xi=zt+Qe,I++}if(Ze<R&&di&&c(Ze,uo++,"post"),u?.(uo),I>0){let Be=(zt-hi)/I;Be!==Ge&&(Ge=Ge*.75+Be*.25)}return I>1&&Rt+I>=R&&(Qe=F-zt,Qe>0&&(Qe=0)),ui?(t(),ui=!1):Ae+zt>P&&o(),{start:Go,end:Ze,totalSize:P,count:I,offset:Qe}}let{axis:i,scrollElement:a,render:c,refresh:l,remove:u}=e,w=i==="x"?"offsetWidth":"offsetHeight",E=i==="x"?"offsetLeft":"offsetTop",S=i==="x"?"scrollLeft":"scrollTop",T=5e6,R=e.dataLength,I=0,F=0,P=0,de=0,Ge=50,Rt=0,ui=!0,Dt=!0,Ko=NaN,Ua=b(a,"scroll",{passive:!0});return f(l?.tap(Ae=>{Ae?.dataLength!==void 0&&(R=Ae.dataLength,Dt=!0),Ko=NaN})??v,wo(a).switchMap(Ae=>Ae?f(J(a).tap(()=>Dt=!0),Ua).raf():v)).filter(()=>Dt||Ko!==a[S]).map(n)}function B0(e){let{axis:t,host:o,translate:r=!0}=e,n=e.scrollElement||o.parentElement;if(!n)throw"scrollElement option could not be resolved.";let i=document.createElement("div"),a=t==="x"?"width":"height";i.style.position="absolute",i.style.width=i.style.height="1px",i.style.top=i.style.left="0",(e.scrollContainer??n).appendChild(i),o.style.position="sticky",o.style.top=o.style.left="0",r&&(o.style.translate="0 0");let c=0,l=!1;return vc({...e,scrollElement:n}).tap(({totalSize:u,offset:w})=>{if(r)if(w!==0){let E=w|0;o.style.translate=t==="x"?`${E}px 0`:`0 ${E}px`,l=!0}else l&&(o.style.translate="0 0",l=!1);c!==u&&(i.style[a]=`${u}px`,c=u)}).finalize(()=>i.remove())}var wc=p(`
...
:host([font=h1]:first-child),:host([font=h2]:first-child),:host([font=h3]:first-child),:host([font=h4]:first-child),:host([font=h5]:first-child),:host([font=h6]:first-child){margin-top:0}
		...
		`),y,e=>{function t(o=1){let r=Array.from(e.tabs),n=e.selected||r[0],i=n?r.indexOf(n):-1;return i===-1?null:r[i+o]||null}return Le({host:e,goRight:t.bind(null,1),goLeft:t.bind(null,-1),goFirst:()=>Array.from(e.tabs)[0]||null,goLast:()=>Array.from(e.tabs)[e.tabs.size-1]||null}).tap(o=>{o.click(),o.focus()})},e=>{let t=new oe;return N(e).append(h(Pe,{className:"selected",$:o=>f(Xe(),m(e,"selected"),m(e,"variant"),t,J(e)).raf(()=>{if(Fe(e))return;let r=e.selected;if(!r)return o.style.transform="scaleX(0)";let n=r.offsetLeft;if(e.variant==="secondary"){let i=r.clientWidth/100;o.style.transform=`translate(${n}px, 0) scaleX(${i})`,o.style.display="block"}else{let i=document.createRange();i.selectNodeContents(r);let{width:a}=i.getBoundingClientRect(),c=n+(r.clientWidth-a)/2,l=a/100;o.style.transform=`translate(${c}px, 0) scaleX(${l})`,o.style.display="block"}e.scrollWidth!==r.clientWidth&&(e.scrollLeft=n-32)})})),Ue("tabs",e,e.tabs).raf().switchMap(o=>{let r=[];for(let n of o.elements)r.push(m(n,"selected").tap(i=>{i?(e.selected&&e.selected!==n&&(e.selected.selected=!1),e.selected=n):e.selected===n&&(e.selected=void 0),n.tabIndex=i?0:-1}),J(n).tap(()=>t.next()));return f(...r)})}]});var Wo=class extends d{selected=!1;touched=!1;disabled=!1;name};s(Wo,{init:[x("touched"),x("selected"),x("disabled"),g("name")],augment:[k("tab"),ce,e=>ae("tabs",e),e=>m(e,"name").switchMap(t=>t?D(e).tap(()=>e.selected=!0):v),e=>m(e,"selected").tap(t=>{e.setAttribute("aria-selected",t?"true":"false")})]});var ri=class extends Wo{};s(ri,{tagName:"c-tab",augment:[p(`
:host {
	--cxl-color-on-surface: var(--cxl-color-on-surface-variant);
	box-sizing: border-box;
	background-color: var(--cxl-color-surface);
...
${L("small",":host { flex-grow: 0 }")}
		`),Q,H,_e,y]});var ni=class extends d{};s(ni,{tagName:"c-table",augment:[k("table"),p(`
:host {
