...
`}function xi(e){return`box-shadow:var(--cxl-elevation-${e});z-index:${e};`}var lt=p(we()),gi={"./theme-dark.js":()=>import("./theme-dark-VB5GOX6M.js")},je=[0,4,8,16,24,32,48,64],st,li,ja;function z(e,t){return e==="xsmall"?`@media(max-width:${H.breakpoints.small}px){${t}}`:`@media(min-width:${H.breakpoints[e]}px){${t}}`}function yo(e){return K(e).map(t=>{let o=H.breakpoints,r=t.contentRect.width,n="xsmall";for(let i in o){if(o[i]>r)return n;n=i}return n})}function qa(e=""){return Object.entries(vi).map(([t,o])=>`:host([color=${t}]) ${e}{ ${o} }`).join("")}function J(e,t,o=""){return hi(e,`
		...
		${qa(o)}
	`)}function hi(e,t){let o=p(t);return d(e,{persist:Ft,render:r=>o(r)})}function re(e,t){return hi(e,Go.map(o=>{let r=t(o);return o===0?`:host ${r}`:`:host([size="${o}"]) ${r}`}).join(""))}function bi(){let e=document.adoptedStyleSheets.indexOf(st);e!==-1&&document.adoptedStyleSheets.splice(e,1)}function Wa(e){st&&bi();let t=e.globalCss??"";e.colors&&(t+=`:root{${mi(e.colors)}}`),t&&(st=Re(t),document.adoptedStyleSheets.push(st)),It.next({theme:e,stylesheet:st,css:t}),ho.next(e.name)}var ci="";function yi(e){e?e!==ci&&(typeof e=="string"?import(e):e()).then(t=>Wa(t.default)):st&&(bi(),It.next(void 0),ho.next("")),ci=e}function Ka(e){let t;return It.tap(o=>{let r=o?.theme.override?.[e.tagName];r?t?t.replace(r):e.shadowRoot?.adoptedStyleSheets.push(t??=Re(r)):t&&t.replace("")})}function Re(e){let t=new CSSStyleSheet;return e&&t.replaceSync(e),t}function vo(e,t=""){let o=Re(t);return M(e).adoptedStyleSheets.push(o),o}function p(e){let t;return o=>{let r=M(o);if(r.adoptedStyleSheets.push(t??=Re(e)),!o[xo])return H.css&&r.adoptedStyleSheets.unshift(ja??=Re(H.css)),o[xo]=!0,Ka(o)}}var $o=["background","primary","primary-container","secondary","secondary-container","tertiary","tertiary-container","surface","surface-container","surface-container-low","surface-container-lowest","surface-container-highest","surface-container-high","error","error-container","success","success-container","warning","warning-container","inverse-surface","inverse-primary"],Nc=[...$o,"inherit"];function Wo(e,t="surface"){return`--cxl-color-${t}: var(--cxl-color--${e});
...
slot[name] { display: inline-block; }
		`),ee,()=>b("slot",{name:"leading"}),y,()=>b("slot",{name:"trailing"})]});var Rr=class extends x{date;format;locale};l(Rr,{tagName:"c-date",init:[Ri("date"),d("format"),d("locale")],augment:[e=>P(m(e,"locale").switchMap(t=>U.getLocale(t)),m(e,"date"),m(e,"format")).raf(([t,o,r])=>e.textContent=o?t.formatDate(o,r):"")]});ft({"dialog.close":"Close dialog","dialog.cancel":"Cancel","dialog.ok":"Ok"});var Fr=p(`
...
${z("small",".content { max-height: 85%; }")}
	`),vt=class extends x{static=!1;open=!1;fullscreen=!1;dialog=document.createElement("dialog");returnValue};l(vt,{init:[d("static"),d("open"),g("fullscreen")],augment:[W,e=>h(e,"keydown").tap(t=>{t.key==="Escape"&&(t.preventDefault(),e.open=!1)}),e=>h(e.dialog,"close").tap(()=>e.open=!1),e=>e.dialog,e=>m(e,"open").tap(t=>{t?e.static?e.dialog.show():Z.openModal({element:e.dialog,close:()=>e.open=!1}):e.dialog.open&&(e.dialog.close(),Me(e,"close"))}),e=>Q(e,"toggle.close").tap(t=>{e.returnValue=t,e.open=!1})]});var Dr=class extends vt{};l(Dr,{tagName:"c-dialog",augment:[Fr,e=>{e.dialog.append(b("slot",{className:"content"}))}]});function Ro(e,t,...o){let r=b(e,t,...o);return new Promise(n=>{let i=()=>{r.removeEventListener("close",i),r.remove(),n(r.returnValue)};r.addEventListener("close",i),r.parentNode||document.body.append(r),r.open=!0})}var $e=class extends vt{};l($e,{tagName:"c-dialog-basic",augment:[Fr,p(`
dialog {
...
:host {
	...
	outline-offset: -1px;
		...
		`),y]});var Tn=class extends x{};l(Tn,{tagName:"c-tbody",augment:[C("rowgroup"),p(":host{display:table-row-group}"),y]});var Rn=class extends x{};l(Rn,{tagName:"c-td",augment:[C("cell"),p(`
:host {
	box-sizing: border-box;
	display: table-cell;
	padding: 0 16px;
	...
	border-bottom: 1px solid var(--cxl-color-outline);
		...
		`),y]});var Dn=class extends x{};l(Dn,{tagName:"c-th",augment:[C("columnheader"),p(`
:host {
	box-sizing: border-box;
	display: table-cell;
	${A("title-medium")}
