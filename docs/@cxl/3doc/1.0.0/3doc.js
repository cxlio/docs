var _a=Object.create;var mr=Object.defineProperty;var Ia=Object.getOwnPropertyDescriptor;var Da=Object.getOwnPropertyNames;var Oa=Object.getPrototypeOf,La=Object.prototype.hasOwnProperty;var Fa=(e,t)=>()=>(e&&(t=e(e=0)),t);var Pa=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Ba=(e,t)=>{for(var n in t)mr(e,n,{get:t[n],enumerable:!0})},za=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Da(t))!La.call(e,o)&&o!==n&&mr(e,o,{get:()=>t[o],enumerable:!(r=Ia(t,o))||r.enumerable});return e};var Ha=(e,t,n)=>(n=e!=null?_a(Oa(e)):{},za(t||!e||!e.__esModule?mr(n,"default",{value:e,enumerable:!0}):n,e));var qo={};Ba(qo,{default:()=>vs,theme:()=>Wo});var ys,Wo,vs,Xo=Fa(()=>{"use strict";ys={primary:"#8ECFF2","on-primary":"#003548","primary-container":"#004D67","on-primary-container":"#C1E8FF",secondary:"#B5C9D7","on-secondary":"#1F333D","secondary-container":"#364954","on-secondary-container":"#D1E6F3",tertiary:"#C9C2EA","on-tertiary":"#312C4C","tertiary-container":"#474364","on-tertiary-container":"#E5DEFF",error:"#FFB4AB","on-error":"#690005","error-container":"#93000A","on-error-container":"#FFDAD6",background:"#0F1417","on-background":"#DFE3E7",surface:"#0F1417","on-surface":"#DFE3E7","surface-variant":"#40484D","on-surface-variant":"#C0C7CD",outline:"#8A9297","outline-variant":"#40484D",shadow:"#000000",scrim:"#000000","inverse-surface":"#DFE3E7","on-inverse-surface":"#2C3134","inverse-primary":"#186584","primary-fixed":"#C1E8FF","on-primary-fixed":"#001E2B","primary-fixed-dim":"#8ECFF2","on-primary-fixed-variant":"#004D67","secondary-fixed":"#D1E6F3","on-secondary-fixed":"#091E28","secondary-fixed-dim":"#B5C9D7","on-secondary-fixed-variant":"#364954","tertiary-fixed":"#E5DEFF","on-tertiary-fixed":"#1B1736","tertiary-fixed-dim":"#C9C2EA","on-tertiary-fixed-variant":"#474364","surface-dim":"#0F1417","surface-bright":"#353A3D","surface-container-lowest":"#0A0F12","surface-container-low":"#171C1F","surface-container":"#1B2023","surface-container-high":"#262B2E","surface-container-highest":"#313539",warning:"#FFC107","on-warning":"#212121","warning-container":"#4E3400","on-warning-container":"#FFF3CF",success:"#81C784","on-success":"#000","success-container":"#2E7D32","on-success-container":"#fff"},Wo={name:"dark",colors:ys},vs=Wo});var wa=Pa((Qh,va)=>{"use strict";function ca(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{let n=e[t],r=typeof n;(r==="object"||r==="function")&&!Object.isFrozen(n)&&ca(n)}),e}var ir=class{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function la(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function He(e,...t){let n=Object.create(null);for(let r in e)n[r]=e[r];return t.forEach(function(r){for(let o in r)n[o]=r[o]}),n}var cl="</span>",na=e=>!!e.scope,ll=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let n=e.split(".");return[`${t}${n.shift()}`,...n.map((r,o)=>`${r}${"_".repeat(o+1)}`)].join(" ")}return`${t}${e}`},xo=class{constructor(t,n){this.buffer="",this.classPrefix=n.classPrefix,t.walk(this)}addText(t){this.buffer+=la(t)}openNode(t){if(!na(t))return;let n=ll(t.scope,{prefix:this.classPrefix});this.span(n)}closeNode(t){na(t)&&(this.buffer+=cl)}value(){return this.buffer}span(t){this.buffer+=`<span class="${t}">`}},ra=(e={})=>{let t={children:[]};return Object.assign(t,e),t},bo=class e{constructor(){this.rootNode=ra(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){let n=ra({scope:t});this.add(n),this.stack.push(n)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,n){return typeof n=="string"?t.addText(n):n.children&&(t.openNode(n),n.children.forEach(r=>this._walk(t,r)),t.closeNode(n)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(n=>typeof n=="string")?t.children=[t.children.join("")]:t.children.forEach(n=>{e._collapse(n)}))}},yo=class extends bo{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,n){let r=t.root;n&&(r.scope=`language:${n}`),this.add(r)}toHTML(){return new xo(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function dn(e){return e?typeof e=="string"?e:e.source:null}function ua(e){return ot("(?=",e,")")}function ul(e){return ot("(?:",e,")*")}function pl(e){return ot("(?:",e,")?")}function ot(...e){return e.map(n=>dn(n)).join("")}function fl(e){let t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function wo(...e){return"("+(fl(e).capture?"":"?:")+e.map(r=>dn(r)).join("|")+")"}function pa(e){return new RegExp(e.toString()+"|").exec("").length-1}function dl(e,t){let n=e&&e.exec(t);return n&&n.index===0}var ml=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function Eo(e,{joinWith:t}){let n=0;return e.map(r=>{n+=1;let o=n,c=dn(r),i="";for(;c.length>0;){let s=ml.exec(c);if(!s){i+=c;break}i+=c.substring(0,s.index),c=c.substring(s.index+s[0].length),s[0][0]==="\\"&&s[1]?i+="\\"+String(Number(s[1])+o):(i+=s[0],s[0]==="("&&n++)}return i}).map(r=>`(${r})`).join(t)}var gl=/\b\B/,fa="[a-zA-Z]\\w*",So="[a-zA-Z_]\\w*",da="\\b\\d+(\\.\\d+)?",ma="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",ga="\\b(0b[01]+)",hl="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",xl=(e={})=>{let t=/^#![ ]*\//;return e.binary&&(e.begin=ot(t,/.*\b/,e.binary,/\b.*/)),He({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(n,r)=>{n.index!==0&&r.ignoreMatch()}},e)},mn={begin:"\\\\[\\s\\S]",relevance:0},bl={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[mn]},yl={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[mn]},vl={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},sr=function(e,t,n={}){let r=He({scope:"comment",begin:e,end:t,contains:[]},n);r.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let o=wo("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return r.contains.push({begin:ot(/[ ]+/,"(",o,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),r},wl=sr("//","$"),El=sr("/\\*","\\*/"),Sl=sr("#","$"),Cl={scope:"number",begin:da,relevance:0},kl={scope:"number",begin:ma,relevance:0},Al={scope:"number",begin:ga,relevance:0},Ml={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[mn,{begin:/\[/,end:/\]/,relevance:0,contains:[mn]}]},Nl={scope:"title",begin:fa,relevance:0},Tl={scope:"title",begin:So,relevance:0},Rl={begin:"\\.\\s*"+So,relevance:0},_l=function(e){return Object.assign(e,{"on:begin":(t,n)=>{n.data._beginMatch=t[1]},"on:end":(t,n)=>{n.data._beginMatch!==t[1]&&n.ignoreMatch()}})},or=Object.freeze({__proto__:null,APOS_STRING_MODE:bl,BACKSLASH_ESCAPE:mn,BINARY_NUMBER_MODE:Al,BINARY_NUMBER_RE:ga,COMMENT:sr,C_BLOCK_COMMENT_MODE:El,C_LINE_COMMENT_MODE:wl,C_NUMBER_MODE:kl,C_NUMBER_RE:ma,END_SAME_AS_BEGIN:_l,HASH_COMMENT_MODE:Sl,IDENT_RE:fa,MATCH_NOTHING_RE:gl,METHOD_GUARD:Rl,NUMBER_MODE:Cl,NUMBER_RE:da,PHRASAL_WORDS_MODE:vl,QUOTE_STRING_MODE:yl,REGEXP_MODE:Ml,RE_STARTERS_RE:hl,SHEBANG:xl,TITLE_MODE:Nl,UNDERSCORE_IDENT_RE:So,UNDERSCORE_TITLE_MODE:Tl});function Il(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function Dl(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function Ol(e,t){t&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=Il,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function Ll(e,t){Array.isArray(e.illegal)&&(e.illegal=wo(...e.illegal))}function Fl(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function Pl(e,t){e.relevance===void 0&&(e.relevance=1)}var Bl=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let n=Object.assign({},e);Object.keys(e).forEach(r=>{delete e[r]}),e.keywords=n.keywords,e.begin=ot(n.beforeMatch,ua(n.begin)),e.starts={relevance:0,contains:[Object.assign(n,{endsParent:!0})]},e.relevance=0,delete n.beforeMatch},zl=["of","and","for","in","not","or","if","then","parent","list","value"],Hl="keyword";function ha(e,t,n=Hl){let r=Object.create(null);return typeof e=="string"?o(n,e.split(" ")):Array.isArray(e)?o(n,e):Object.keys(e).forEach(function(c){Object.assign(r,ha(e[c],t,c))}),r;function o(c,i){t&&(i=i.map(s=>s.toLowerCase())),i.forEach(function(s){let a=s.split("|");r[a[0]]=[c,$l(a[0],a[1])]})}}function $l(e,t){return t?Number(t):jl(e)?0:1}function jl(e){return zl.includes(e.toLowerCase())}var oa={},rt=e=>{console.error(e)},ia=(e,...t)=>{console.log(`WARN: ${e}`,...t)},Ct=(e,t)=>{oa[`${e}/${t}`]||(console.log(`Deprecated as of ${e}. ${t}`),oa[`${e}/${t}`]=!0)},ar=new Error;function xa(e,t,{key:n}){let r=0,o=e[n],c={},i={};for(let s=1;s<=t.length;s++)i[s+r]=o[s],c[s+r]=!0,r+=pa(t[s-1]);e[n]=i,e[n]._emit=c,e[n]._multi=!0}function Vl(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw rt("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),ar;if(typeof e.beginScope!="object"||e.beginScope===null)throw rt("beginScope must be object"),ar;xa(e,e.begin,{key:"beginScope"}),e.begin=Eo(e.begin,{joinWith:""})}}function Ul(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw rt("skip, excludeEnd, returnEnd not compatible with endScope: {}"),ar;if(typeof e.endScope!="object"||e.endScope===null)throw rt("endScope must be object"),ar;xa(e,e.end,{key:"endScope"}),e.end=Eo(e.end,{joinWith:""})}}function Gl(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function Yl(e){Gl(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),Vl(e),Ul(e)}function Wl(e){function t(i,s){return new RegExp(dn(i),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(s?"g":""))}class n{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(s,a){a.position=this.position++,this.matchIndexes[this.matchAt]=a,this.regexes.push([a,s]),this.matchAt+=pa(s)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let s=this.regexes.map(a=>a[1]);this.matcherRe=t(Eo(s,{joinWith:"|"}),!0),this.lastIndex=0}exec(s){this.matcherRe.lastIndex=this.lastIndex;let a=this.matcherRe.exec(s);if(!a)return null;let l=a.findIndex((m,P)=>P>0&&m!==void 0),C=this.matchIndexes[l];return a.splice(0,l),Object.assign(a,C)}}class r{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(s){if(this.multiRegexes[s])return this.multiRegexes[s];let a=new n;return this.rules.slice(s).forEach(([l,C])=>a.addRule(l,C)),a.compile(),this.multiRegexes[s]=a,a}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(s,a){this.rules.push([s,a]),a.type==="begin"&&this.count++}exec(s){let a=this.getMatcher(this.regexIndex);a.lastIndex=this.lastIndex;let l=a.exec(s);if(this.resumingScanAtSamePosition()&&!(l&&l.index===this.lastIndex)){let C=this.getMatcher(0);C.lastIndex=this.lastIndex+1,l=C.exec(s)}return l&&(this.regexIndex+=l.position+1,this.regexIndex===this.count&&this.considerAll()),l}}function o(i){let s=new r;return i.contains.forEach(a=>s.addRule(a.begin,{rule:a,type:"begin"})),i.terminatorEnd&&s.addRule(i.terminatorEnd,{type:"end"}),i.illegal&&s.addRule(i.illegal,{type:"illegal"}),s}function c(i,s){let a=i;if(i.isCompiled)return a;[Dl,Fl,Yl,Bl].forEach(C=>C(i,s)),e.compilerExtensions.forEach(C=>C(i,s)),i.__beforeBegin=null,[Ol,Ll,Pl].forEach(C=>C(i,s)),i.isCompiled=!0;let l=null;return typeof i.keywords=="object"&&i.keywords.$pattern&&(i.keywords=Object.assign({},i.keywords),l=i.keywords.$pattern,delete i.keywords.$pattern),l=l||/\w+/,i.keywords&&(i.keywords=ha(i.keywords,e.case_insensitive)),a.keywordPatternRe=t(l,!0),s&&(i.begin||(i.begin=/\B|\b/),a.beginRe=t(a.begin),!i.end&&!i.endsWithParent&&(i.end=/\B|\b/),i.end&&(a.endRe=t(a.end)),a.terminatorEnd=dn(a.end)||"",i.endsWithParent&&s.terminatorEnd&&(a.terminatorEnd+=(i.end?"|":"")+s.terminatorEnd)),i.illegal&&(a.illegalRe=t(i.illegal)),i.contains||(i.contains=[]),i.contains=[].concat(...i.contains.map(function(C){return ql(C==="self"?i:C)})),i.contains.forEach(function(C){c(C,a)}),i.starts&&c(i.starts,s),a.matcher=o(a),a}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=He(e.classNameAliases||{}),c(e)}function ba(e){return e?e.endsWithParent||ba(e.starts):!1}function ql(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return He(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:ba(e)?He(e,{starts:e.starts?He(e.starts):null}):Object.isFrozen(e)?He(e):e}var Xl="11.11.1",vo=class extends Error{constructor(t,n){super(t),this.name="HTMLInjectionError",this.html=n}},ho=la,aa=He,sa=Symbol("nomatch"),Jl=7,ya=function(e){let t=Object.create(null),n=Object.create(null),r=[],o=!0,c="Could not find the language '{}', did you forget to load/include a language module?",i={disableAutodetect:!0,name:"Plain text",contains:[]},s={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:yo};function a(p){return s.noHighlightRe.test(p)}function l(p){let x=p.className+" ";x+=p.parentNode?p.parentNode.className:"";let A=s.languageDetectRe.exec(x);if(A){let O=me(A[1]);return O||(ia(c.replace("{}",A[1])),ia("Falling back to no-highlight mode for this block.",p)),O?A[1]:"no-highlight"}return x.split(/\s+/).find(O=>a(O)||me(O))}function C(p,x,A){let O="",Y="";typeof x=="object"?(O=p,A=x.ignoreIllegals,Y=x.language):(Ct("10.7.0","highlight(lang, code, ...args) has been deprecated."),Ct("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),Y=p,O=x),A===void 0&&(A=!0);let de={code:O,language:Y};w("before:highlight",de);let Ie=de.result?de.result:m(de.language,de.code,A);return Ie.code=de.code,w("after:highlight",Ie),Ie}function m(p,x,A,O){let Y=Object.create(null);function de(v,M){return v.keywords[M]}function Ie(){if(!D.keywords){Z.addText(j);return}let v=0;D.keywordPatternRe.lastIndex=0;let M=D.keywordPatternRe.exec(j),L="";for(;M;){L+=j.substring(v,M.index);let H=he.case_insensitive?M[0].toLowerCase():M[0],ne=de(D,H);if(ne){let[Ce,Ta]=ne;if(Z.addText(L),L="",Y[H]=(Y[H]||0)+1,Y[H]<=Jl&&(wn+=Ta),Ce.startsWith("_"))L+=M[0];else{let Ra=he.classNameAliases[Ce]||Ce;ge(M[0],Ra)}}else L+=M[0];v=D.keywordPatternRe.lastIndex,M=D.keywordPatternRe.exec(j)}L+=j.substring(v),Z.addText(L)}function yn(){if(j==="")return;let v=null;if(typeof D.subLanguage=="string"){if(!t[D.subLanguage]){Z.addText(j);return}v=m(D.subLanguage,j,!0,To[D.subLanguage]),To[D.subLanguage]=v._top}else v=R(j,D.subLanguage.length?D.subLanguage:null);D.relevance>0&&(wn+=v.relevance),Z.__addSublanguage(v._emitter,v.language)}function ce(){D.subLanguage!=null?yn():Ie(),j=""}function ge(v,M){v!==""&&(Z.startScope(M),Z.addText(v),Z.endScope())}function ko(v,M){let L=1,H=M.length-1;for(;L<=H;){if(!v._emit[L]){L++;continue}let ne=he.classNameAliases[v[L]]||v[L],Ce=M[L];ne?ge(Ce,ne):(j=Ce,Ie(),j=""),L++}}function Ao(v,M){return v.scope&&typeof v.scope=="string"&&Z.openNode(he.classNameAliases[v.scope]||v.scope),v.beginScope&&(v.beginScope._wrap?(ge(j,he.classNameAliases[v.beginScope._wrap]||v.beginScope._wrap),j=""):v.beginScope._multi&&(ko(v.beginScope,M),j="")),D=Object.create(v,{parent:{value:D}}),D}function Mo(v,M,L){let H=dl(v.endRe,L);if(H){if(v["on:end"]){let ne=new ir(v);v["on:end"](M,ne),ne.isMatchIgnored&&(H=!1)}if(H){for(;v.endsParent&&v.parent;)v=v.parent;return v}}if(v.endsWithParent)return Mo(v.parent,M,L)}function Ca(v){return D.matcher.regexIndex===0?(j+=v[0],1):(dr=!0,0)}function ka(v){let M=v[0],L=v.rule,H=new ir(L),ne=[L.__beforeBegin,L["on:begin"]];for(let Ce of ne)if(Ce&&(Ce(v,H),H.isMatchIgnored))return Ca(M);return L.skip?j+=M:(L.excludeBegin&&(j+=M),ce(),!L.returnBegin&&!L.excludeBegin&&(j=M)),Ao(L,v),L.returnBegin?0:M.length}function Aa(v){let M=v[0],L=x.substring(v.index),H=Mo(D,v,L);if(!H)return sa;let ne=D;D.endScope&&D.endScope._wrap?(ce(),ge(M,D.endScope._wrap)):D.endScope&&D.endScope._multi?(ce(),ko(D.endScope,v)):ne.skip?j+=M:(ne.returnEnd||ne.excludeEnd||(j+=M),ce(),ne.excludeEnd&&(j=M));do D.scope&&Z.closeNode(),!D.skip&&!D.subLanguage&&(wn+=D.relevance),D=D.parent;while(D!==H.parent);return H.starts&&Ao(H.starts,v),ne.returnEnd?0:M.length}function Ma(){let v=[];for(let M=D;M!==he;M=M.parent)M.scope&&v.unshift(M.scope);v.forEach(M=>Z.openNode(M))}let vn={};function No(v,M){let L=M&&M[0];if(j+=v,L==null)return ce(),0;if(vn.type==="begin"&&M.type==="end"&&vn.index===M.index&&L===""){if(j+=x.slice(M.index,M.index+1),!o){let H=new Error(`0 width match regex (${p})`);throw H.languageName=p,H.badRule=vn.rule,H}return 1}if(vn=M,M.type==="begin")return ka(M);if(M.type==="illegal"&&!A){let H=new Error('Illegal lexeme "'+L+'" for mode "'+(D.scope||"<unnamed>")+'"');throw H.mode=D,H}else if(M.type==="end"){let H=Aa(M);if(H!==sa)return H}if(M.type==="illegal"&&L==="")return j+=`
`,1;if(fr>1e5&&fr>M.index*3)throw new Error("potential infinite loop, way more iterations than matches");return j+=L,L.length}let he=me(p);if(!he)throw rt(c.replace("{}",p)),new Error('Unknown language: "'+p+'"');let Na=Wl(he),pr="",D=O||Na,To={},Z=new s.__emitter(s);Ma();let j="",wn=0,je=0,fr=0,dr=!1;try{if(he.__emitTokens)he.__emitTokens(x,Z);else{for(D.matcher.considerAll();;){fr++,dr?dr=!1:D.matcher.considerAll(),D.matcher.lastIndex=je;let v=D.matcher.exec(x);if(!v)break;let M=x.substring(je,v.index),L=No(M,v);je=v.index+L}No(x.substring(je))}return Z.finalize(),pr=Z.toHTML(),{language:p,value:pr,relevance:wn,illegal:!1,_emitter:Z,_top:D}}catch(v){if(v.message&&v.message.includes("Illegal"))return{language:p,value:ho(x),illegal:!0,relevance:0,_illegalBy:{message:v.message,index:je,context:x.slice(je-100,je+100),mode:v.mode,resultSoFar:pr},_emitter:Z};if(o)return{language:p,value:ho(x),illegal:!1,relevance:0,errorRaised:v,_emitter:Z,_top:D};throw v}}function P(p){let x={value:ho(p),illegal:!1,relevance:0,_top:i,_emitter:new s.__emitter(s)};return x._emitter.addText(p),x}function R(p,x){x=x||s.languages||Object.keys(t);let A=P(p),O=x.filter(me).filter(Mt).map(ce=>m(ce,p,!1));O.unshift(A);let Y=O.sort((ce,ge)=>{if(ce.relevance!==ge.relevance)return ge.relevance-ce.relevance;if(ce.language&&ge.language){if(me(ce.language).supersetOf===ge.language)return 1;if(me(ge.language).supersetOf===ce.language)return-1}return 0}),[de,Ie]=Y,yn=de;return yn.secondBest=Ie,yn}function $(p,x,A){let O=x&&n[x]||A;p.classList.add("hljs"),p.classList.add(`language-${O}`)}function W(p){let x=null,A=l(p);if(a(A))return;if(w("before:highlightElement",{el:p,language:A}),p.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",p);return}if(p.children.length>0&&(s.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(p)),s.throwUnescapedHTML))throw new vo("One of your code blocks includes unescaped HTML.",p.innerHTML);x=p;let O=x.textContent,Y=A?C(O,{language:A,ignoreIllegals:!0}):R(O);p.innerHTML=Y.value,p.dataset.highlighted="yes",$(p,A,Y.language),p.result={language:Y.language,re:Y.relevance,relevance:Y.relevance},Y.secondBest&&(p.secondBest={language:Y.secondBest.language,relevance:Y.secondBest.relevance}),w("after:highlightElement",{el:p,result:Y,text:O})}function ae(p){s=aa(s,p)}let te=()=>{it(),Ct("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function At(){it(),Ct("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let $e=!1;function it(){function p(){it()}if(document.readyState==="loading"){$e||window.addEventListener("DOMContentLoaded",p,!1),$e=!0;return}document.querySelectorAll(s.cssSelector).forEach(W)}function gn(p,x){let A=null;try{A=x(e)}catch(O){if(rt("Language definition for '{}' could not be registered.".replace("{}",p)),o)rt(O);else throw O;A=i}A.name||(A.name=p),t[p]=A,A.rawDefinition=x.bind(null,e),A.aliases&&hn(A.aliases,{languageName:p})}function cr(p){delete t[p];for(let x of Object.keys(n))n[x]===p&&delete n[x]}function lr(){return Object.keys(t)}function me(p){return p=(p||"").toLowerCase(),t[p]||t[n[p]]}function hn(p,{languageName:x}){typeof p=="string"&&(p=[p]),p.forEach(A=>{n[A.toLowerCase()]=x})}function Mt(p){let x=me(p);return x&&!x.disableAutodetect}function ur(p){p["before:highlightBlock"]&&!p["before:highlightElement"]&&(p["before:highlightElement"]=x=>{p["before:highlightBlock"](Object.assign({block:x.el},x))}),p["after:highlightBlock"]&&!p["after:highlightElement"]&&(p["after:highlightElement"]=x=>{p["after:highlightBlock"](Object.assign({block:x.el},x))})}function xn(p){ur(p),r.push(p)}function bn(p){let x=r.indexOf(p);x!==-1&&r.splice(x,1)}function w(p,x){let A=p;r.forEach(function(O){O[A]&&O[A](x)})}function k(p){return Ct("10.7.0","highlightBlock will be removed entirely in v12.0"),Ct("10.7.0","Please use highlightElement now."),W(p)}Object.assign(e,{highlight:C,highlightAuto:R,highlightAll:it,highlightElement:W,highlightBlock:k,configure:ae,initHighlighting:te,initHighlightingOnLoad:At,registerLanguage:gn,unregisterLanguage:cr,listLanguages:lr,getLanguage:me,registerAliases:hn,autoDetection:Mt,inherit:aa,addPlugin:xn,removePlugin:bn}),e.debugMode=function(){o=!1},e.safeMode=function(){o=!0},e.versionString=Xl,e.regex={concat:ot,lookahead:ua,either:wo,optional:pl,anyNumberOfTimes:ul};for(let p in or)typeof or[p]=="object"&&ca(or[p]);return Object.assign(e,or),e},kt=ya({});kt.newInstance=()=>ya({});va.exports=kt;kt.HighlightJS=kt;kt.default=kt});var Ve={},Ql=Symbol("terminator");function $a(e,t){let n=!1,r={error:o,unsubscribe:c,get closed(){return n},signal:new De,next(i){if(!n)try{e.next?.(i)}catch(s){o(s)}},complete(){if(!n)try{e.complete?.()}finally{c()}}};e.signal?.subscribe(c);function o(i){if(n)throw i;if(!e.error)throw c(),i;try{e.error(i)}finally{c()}}function c(){n||(n=!0,r.signal.next())}try{if(t?.(r))throw new Error("Unsubscribe function result is deprectaed")}catch(i){o(i)}return r}var _=class{__subscribe;constructor(t){this.__subscribe=t}then(t,n){return Ua(this).then(t,n)}pipe(...t){return t.reduce((n,r)=>r(n),this)}subscribe(t){return $a(!t||typeof t=="function"?{next:t}:t,this.__subscribe)}},Ue=class extends _{closed=!1;signal=new De;observers=new Set;constructor(){super(t=>this.onSubscribe(t))}next(t){if(!this.closed)for(let n of Array.from(this.observers))n.closed||n.next(t)}error(t){if(!this.closed){this.closed=!0;let n=!1,r;for(let o of Array.from(this.observers))try{o.error(t)}catch(c){n=!0,r=c}if(n)throw r}}complete(){this.closed||(this.closed=!0,Array.from(this.observers).forEach(t=>t.complete()),this.observers.clear())}onSubscribe(t){this.closed?t.complete():(this.observers.add(t),t.signal.subscribe(()=>this.observers.delete(t)))}},De=class extends _{closed=!1;observers=new Set;constructor(){super(t=>{this.closed?(t.next(),t.complete()):this.observers.add(t)})}next(){if(!this.closed){this.closed=!0;for(let t of Array.from(this.observers))t.closed||(t.next(),t.complete());this.observers.clear()}}},En=class extends Ue{queue=[];emitting=!1;next(t){if(!this.closed)if(this.emitting)this.queue.push(t);else{for(this.emitting=!0,super.next(t);this.queue.length;)super.next(this.queue.shift());this.emitting=!1}}},Nt=class extends Ue{currentValue;constructor(t){super(),this.currentValue=t}get value(){return this.currentValue}next(t){this.currentValue=t,super.next(t)}onSubscribe(t){let n=super.onSubscribe(t);return this.closed||t.next(this.currentValue),n}},gr=class extends Ue{bufferSize;buffer=[];hasError=!1;lastError;constructor(t=1/0){super(),this.bufferSize=t}error(t){this.hasError=!0,this.lastError=t,super.error(t)}next(t){return this.buffer.length===this.bufferSize&&this.buffer.shift(),this.buffer.push(t),super.next(t)}onSubscribe(t){this.observers.add(t),this.buffer.forEach(n=>t.next(n)),this.hasError?t.error(this.lastError):this.closed&&t.complete(),t.signal.subscribe(()=>this.observers.delete(t))}},at=class extends Ue{$value=Ve;get hasValue(){return this.$value!==Ve}get value(){if(this.$value===Ve)throw new Error("Reference not initialized");return this.$value}next(t){return this.$value=t,super.next(t)}onSubscribe(t){!this.closed&&this.$value!==Ve&&t.next(this.$value),super.onSubscribe(t)}},hr=class extends Error{message="No elements in sequence"};function ke(...e){return new _(t=>{let n=0,r;function o(){let c=e[n++];c&&!t.closed?(r?.next(),c.subscribe({next:t.next,error:t.error,complete:o,signal:r=new De})):t.complete()}t.signal.subscribe(()=>r?.next()),o()})}function Q(e){return new _(t=>{e().subscribe(t)})}function _o(e){return new _(t=>{for(let n of e)t.closed||t.next(n);t.complete()})}function Io(e){return new _(t=>{e.then(n=>{t.closed||t.next(n),t.complete()}).catch(n=>t.error(n))})}function Sn(e){return Q(()=>Io(e()))}function ja(e){return new _(t=>{for(let n of e)t.closed||t.next(n);t.complete()})}function Cn(e){return e instanceof _?e:Array.isArray(e)?_o(e):e instanceof Promise?Io(e):ja(e)}function F(...e){return _o(e)}function Va(e){return new Promise((t,n)=>{let r=Ve;e.subscribe({next:o=>r=o,error:o=>n(o),complete:()=>t(r)})})}function Ua(e){return Va(e).then(t=>t===Ve?void 0:t)}function st(e,t){return Ae(n=>({next:e(n),unsubscribe:t}))}function Ae(e){return t=>new _(n=>{let r=e(n,t);n.signal.subscribe(()=>r.unsubscribe?.()),r.error||(r.error=n.error),r.complete||(r.complete=n.complete),r.signal=n.signal,t.subscribe(r)})}function xr(e){return st(t=>n=>t.next(e(n)))}function Ga(e,t){return Ae(n=>{let r=t,o=0;return{next(c){r=e(r,c,o++)},complete(){n.next(r),n.complete()}}})}function Ya(e){return Ae(t=>{let n=!0,r;return{next(o){n&&(n=!1,t.next(o),r=setTimeout(()=>n=!0,e))},unsubscribe:()=>clearTimeout(r)}})}function Ge(e){return new _(t=>{let n=setTimeout(()=>{t.next(),t.complete()},e);t.signal.subscribe(()=>clearTimeout(n))})}function Wa(e,t=Ge){return Do(n=>t(e).map(()=>n))}function Do(e){return t=>K(n=>{let r=!1,o=!1,c,i=()=>{c?.next(),r=!1,o&&n.complete()},s=new De;n.signal.subscribe(()=>{i(),s.next()}),t.subscribe({next(a){i(),c=new De,r=!0,e(a).subscribe({next:n.next,error:n.error,complete:i,signal:c})},error:n.error,complete(){o=!0,r||n.complete()},signal:s})})}function qa(e){return t=>K(n=>{let r=n.signal,o=0,c=0,i=!1;t.subscribe({next:s=>{o++,e(s).subscribe({next:n.next,error:n.error,complete:()=>{c++,i&&c===o&&n.complete()},signal:r})},error:n.error,complete(){i=!0,c===o&&n.complete()},signal:r})})}function Xa(e){return Ae(t=>{let n=!0;return{next(r){n&&(n=!1,e(r).subscribe({next:t.next,error:t.error,complete:()=>n=!0,signal:t.signal}))}}})}function kn(e){return st(t=>n=>{e(n)&&t.next(n)})}function Ja(e){return st(t=>n=>{e-- >0&&!t.closed&&t.next(n),(e<=0||t.closed)&&t.complete()})}function Za(e){return st(t=>n=>{!t.closed&&e(n)?t.next(n):t.complete()})}function Qa(){let e=!1;return Ae(t=>({next(n){e||(e=!0,t.next(n),t.complete())},complete(){t.closed||t.error(new hr)}}))}function Tt(e){return st(t=>n=>{e(n),t.next(n)})}function Ka(e){return Ae((t,n)=>{let r,o={next:t.next,error(c){try{if(t.closed)return;let i=e(c,n);i&&(r?.next(),r=new De,i.subscribe({...o,signal:r}))}catch(i){t.error(i)}},unsubscribe:()=>r?.next()};return o})}function es(){return st(e=>{let t=Ve;return n=>{n!==t&&(t=n,e.next(n))}})}function ts(){return e=>{let t=new gr(1),n=!1;return K(r=>{t.subscribe(r),n||(n=!0,e.subscribe(t))})}}function ns(){return e=>{let t,n=0;function r(){--n===0&&t?.signal.next()}return K(o=>{o.signal.subscribe(r),n++===0?(t=Ye(),t.subscribe(o),e.subscribe(t)):t.subscribe(o)})}}function rs(){return e=>{let t=new Ue,n,r,o=!1,c=!1;return K(i=>{c?(i.next(r),i.complete()):t.subscribe(i),n??=e.subscribe({next:s=>{o=!0,r=s},error:i.error,complete(){c=!0,o&&t.next(r),t.complete()},signal:i.signal})})}}function f(...e){return e.length===1?e[0]:new _(t=>{let n=e.length;for(let r of e)t.closed||r.subscribe({next:t.next,error:t.error,complete(){n--===1&&t.complete()},signal:t.signal})})}function oe(...e){return e.length===0?T:new _(t=>{let n=e.length,r=n,o=0,c=!1,i=new Array(n),s=new Array(n);e.forEach((a,l)=>a.subscribe({next(C){s[l]=C,i[l]||(i[l]=!0,++o>=r&&(c=!0)),c&&t.next(s.slice(0))},error:t.error,complete(){--n<=0&&t.complete()},signal:t.signal}))})}function os(e){return Ae(t=>({next:t.next,unsubscribe:e}))}function is(){return kn(()=>!1)}var T=new _(e=>e.complete());function ie(e){return new Nt(e)}function K(e){return new _(e)}function Ye(){return new at}var Ro={catchError:Ka,debounceTime:Wa,distinctUntilChanged:es,exhaustMap:Xa,filter:kn,finalize:os,first:Qa,ignoreElements:is,map:xr,mergeMap:qa,publishLast:rs,reduce:Ga,share:ns,shareLatest:ts,switchMap:Do,take:Ja,takeWhile:Za,tap:Tt,throttleTime:Ya};for(let e in Ro)_.prototype[e]=function(...t){return this.pipe(Ro[e](...t))};function S(e,t,n){return new _(r=>{let o=r.next.bind(r);e.addEventListener(t,o,n),r.signal.subscribe(()=>e.removeEventListener(t,o,n))})}function An(e){return br(e,{childList:!0})}function Mn(e,t){return br(e,{attributes:!0,attributeFilter:t})}function br(e,t={attributes:!0,childList:!0}){return new _(n=>{let r=new MutationObserver(o=>o.forEach(c=>{for(let i of c.addedNodes)n.next({type:"added",target:e,value:i});for(let i of c.removedNodes)n.next({type:"removed",target:e,value:i});c.type==="characterData"?n.next({type:"characterData",target:e}):c.attributeName&&n.next({type:"attribute",target:e,value:c.attributeName})}));r.observe(e,t),n.signal.subscribe(()=>r.disconnect())})}function Nn(e){return S(e,"keydown").filter(t=>t.key===" "||t.key==="Enter"?(t.preventDefault(),!0):!1)}function q(e){return S(e,"click")}function Tn(e,t){return new _(n=>{let r=new IntersectionObserver(o=>{for(let c of o)n.next(c)},t);r.observe(e),n.signal.subscribe(()=>r.disconnect())})}function Oo(e){return Tn(e).map(t=>t.isIntersecting)}function Me(e){return Tn(e).filter(t=>t.isIntersecting).first()}function as(e){let t;return function(...n){t&&cancelAnimationFrame(t),t=requestAnimationFrame(()=>{e.apply(this,n),t=0})}}function Lo(e){return Ae(t=>{let n=as(o=>{t.closed||(e&&e(o),t.next(o),r&&t.complete())}),r=!1;return{next:n,complete:()=>r=!0}})}function Fo(){return Q(()=>document.readyState!=="loading"?F(!0):S(window,"DOMContentLoaded").first().map(()=>!0))}function Rn(e,t,n){let r=new CustomEvent(t,n);e.dispatchEvent(r)}function _n(e,t){let n;return f(Q(()=>(n=e.childNodes,n?F(n):T)),br(e,{childList:!0,...t}),Ne().switchMap(()=>e.childNodes!==n?(n=e.childNodes,F(n)):T))}function Ne(){return Q(()=>document.readyState==="complete"?F(!0):S(window,"load").first().map(()=>!0))}function In(...e){return new _(t=>{let n=new ResizeObserver(r=>r.forEach(o=>t.next(o)));for(let r of e)n.observe(r);t.signal.subscribe(()=>n.disconnect())})}function Rt(e){return e.offsetParent===null&&!(e.offsetWidth&&e.offsetHeight)}function yr(e,t,n){return r=>ke(F(e?r.matches(e):!1),S(r,t).switchMap(()=>f(F(!0),S(r,n).map(()=>e?r.matches(e):!1))))}var tu=yr("","animationstart","animationend"),vr=yr("","mouseenter","mouseleave"),ss=yr(":focus,:focus-within","focusin","focusout"),wr=e=>oe(vr(e),ss(e)).map(([t,n])=>t||n);function Po(e,t,n){return t=t?.toLowerCase(),S(e,"keydown",n).filter(r=>!t||r.key?.toLowerCase()===t)}function _t(e){return e instanceof PointerEvent&&e.pointerType===""||e instanceof MouseEvent&&e.type==="click"&&e.detail===0}function We(e){let t=e.getRootNode();return t instanceof Document||t instanceof ShadowRoot?t:void 0}var cs=Tt(e=>console.log(e));_.prototype.log=function(){return this.pipe(cs)};_.prototype.raf=function(e){return this.pipe(Lo(e))};var ee=Symbol("bindings"),ls={},ct=Symbol("augments"),qe=Symbol("parser"),Sr=class{bindings;messageHandlers;internals;attributes$=new En;wasConnected=!1;wasInitialized=!1;subscriptions;prebind;addMessageHandler(t){(this.messageHandlers??=new Set).add(t)}removeMessageHandler(t){this.messageHandlers?.delete(t)}message(t,n){let r=!1;if(this.messageHandlers)for(let o of this.messageHandlers)o.type===t&&(o.next(n),r||=o.stopPropagation);return r}add(t){if(this.wasConnected)throw new Error("Cannot bind connected component.");this.wasInitialized?(this.bindings??=[]).push(t):(this.prebind??=[]).push(t)}connect(){if(this.wasConnected=!0,!this.subscriptions&&(this.prebind||this.bindings)){let t=this.subscriptions=[];if(this.bindings)for(let n of this.bindings)t.push(n.subscribe());if(this.prebind)for(let n of this.prebind)t.push(n.subscribe())}}disconnect(){this.subscriptions?.forEach(t=>t.unsubscribe()),this.subscriptions=void 0}},On=Symbol("css"),g=class extends HTMLElement{static observedAttributes;static[ct];static[qe];[ee]=new Sr;[On];connectedCallback(){this[ee].wasInitialized=!0,this[ee].wasConnected||this.constructor[ct]?.forEach(t=>t(this)),this[ee].connect()}disconnectedCallback(){this[ee].disconnect()}attributeChangedCallback(t,n,r){let o=this.constructor[qe]?.[t]??us;n!==r&&(this[t]=o(r,this[t]))}};function us(e,t){let n=t===!1||t===!0;return e===""?n?!0:"":e===null?n?!1:void 0:e}function Bo(e,t){e.hasOwnProperty(ct)||(e[ct]=e[ct]?.slice(0)??[]),e[ct]?.push(t)}var ps={mode:"open"};function z(e){return e.shadowRoot??e.attachShadow(ps)}function zo(e,t){t instanceof Node?z(e).appendChild(t):e[ee].add(t)}function fs(e,t){t.length&&Bo(e,n=>{for(let r of t){let o=r.call(e,n);o&&o!==n&&zo(n,o)}})}function ds(e,t){ls[e]=t,customElements.define(e,t)}function xe(e){return e[ee].internals??=e.attachInternals()}function u(e,{init:t,augment:n,tagName:r}){if(t)for(let o of t)o(e);n&&fs(e,n),r&&ds(r,e)}function Oe(e){return ke(F(e),e[ee].attributes$.map(()=>e))}function V(e,t){return e[ee].attributes$.pipe(kn(n=>n.attribute===t),xr(()=>e[t]))}function h(e,t){return f(V(e,t),Q(()=>F(e[t])))}function ms(e){let t=e.observedAttributes;return t&&!e.hasOwnProperty("observedAttributes")&&(t=e.observedAttributes?.slice(0)),e.observedAttributes=t||[]}function It(e,t,n){return n===!1||n===null||n===void 0?n=null:n===!0&&(n=""),n===null?e.removeAttribute(t):e.setAttribute(t,String(n)),n}function gs(e,t,n){e.hasOwnProperty(qe)||(e[qe]={...e[qe]}),e[qe]&&(e[qe][t]=n)}function y(e,t){return n=>{t?.observe!==!1&&ms(n).push(e),t?.parse&&gs(n,e,t.parse);let r=`$$${e}`,o=n.prototype,c=Object.getOwnPropertyDescriptor(o,e);c&&Object.defineProperty(o,r,c);let i=t?.persist,s={enumerable:!0,configurable:!1,get(){return this[r]},set(a){this[r]!==a?(this[r]=a,i?.(this,e,a),this[ee].attributes$.next({target:this,attribute:e,value:a})):c?.set&&(i?.(this,e,a),this[r]=a)}};Bo(n,a=>{if(c||(a[r]=a[e]),Object.defineProperty(a,e,s),i?.(a,e,a[e]),t?.render){let l=t.render(a);l&&zo(a,l)}})}}function b(e){return y(e,{persist:It,observe:!0})}function Ho(e){let t=`on${e}`;return y(t,{render(n){return h(n,t).switchMap(r=>r?new _(o=>{let c=i=>{i.target===n&&n[t]?.call(n,i)};n.addEventListener(e,c),o.signal.subscribe(()=>n.removeEventListener(e,c))}):T)},parse(n){return n?new Function("event",n):void 0}})}function X(e){return y(e,{observe:!1})}function I(){return document.createElement("slot")}function $o(e){return t=>{let[n,r]=e();return t[ee].add(n),r}}var lt=class extends g{};u(lt,{tagName:"c-span"});function hs(e,t){let n=document.createTextNode("");return e[ee].add(t.tap(r=>n.textContent=r)),n}var Er=document.createDocumentFragment();function Dn(e,t,n=e){if(t!=null)if(Array.isArray(t)){for(let r of t)Dn(e,r,Er);n!==Er&&n.appendChild(Er)}else e instanceof g&&t instanceof _?n.appendChild(hs(e,t)):t instanceof Node?n.appendChild(t):e instanceof g&&typeof t=="function"?Dn(e,t(e),n):n.appendChild(document.createTextNode(t))}function jo(e,t){for(let n in t){let r=t[n];e instanceof g?r instanceof _?e[ee].add(n==="$"?r:r.tap(o=>e[n]=o)):n==="$"&&typeof r=="function"?e[ee].add(r(e)):e[n]=r:e[n]=r}}function xs(e,t){return e.constructor.observedAttributes?.includes(t)}function Vo(e,t){let n=e instanceof g&&xs(e,t)?V(e,t):Mn(e,[t]).map(()=>e[t]);return f(n,Q(()=>F(e[t])))}function Ln(e,t,n){return y(e,{parse(r){if(r==="Infinity"||r==="infinity")return 1/0;let o=r===void 0?void 0:Number(r);return t!==void 0&&(o===void 0||o<t||isNaN(o))&&(o=t),n!==void 0&&o!==void 0&&o>n&&(o=n),o}})}function le(e,t,n){for(let r=e.parentElement;r;r=r.parentElement)if(r[ee]?.message(t,n))return}function pe(e,t,n=!0){return new _(r=>{let o={type:t,next:r.next,stopPropagation:n};e[ee].addMessageHandler(o),r.signal.subscribe(()=>e[ee].removeMessageHandler(o))})}function N(e,t,...n){let r=typeof e=="string"?document.createElement(e):new e;return t&&jo(r,t),n&&Dn(r,n),r}function E(e,t,...n){if(e!==E&&typeof e=="function"&&!(e.prototype instanceof g))return n.length&&((t??={}).children=n),e(t);let r=e===E?document.createDocumentFragment():typeof e=="string"?document.createElement(e):new e;return t&&jo(r,t),n&&Dn(r,n),r}function bs(e,t){return n=>new _(()=>{n.hasAttribute(e)||n.setAttribute(e,t)})}function Uo(e,t){return Tt(n=>e.setAttribute("aria-"+t,n===!0?"true":n===!1?"false":n.toString()))}function G(e){return bs("role",e)}var Go=0;function Te(e){return e.id||=`cxl__${Go++}`}function Yo(e){return Vo(e,"id").map(t=>(t||(e.id=`cxl__${Go++}`),e.id))}var pt=d(":host{display:contents}"),ws=[-2,-1,0,1,2,3,4,5],ei=["display-large","display-medium","display-small","body-large","body-medium","body-small","label-large","label-medium","label-small","headline-large","headline-medium","headline-small","title-large","title-medium","title-small","code"],Dt=Ye(),Fn=ie(""),be=d(`:host([disabled]) {
	cursor: default;
...
`}var Pn=d(Ot()),oi={"./theme-dark.js":()=>Promise.resolve().then(()=>(Xo(),qo))},Xe=[0,4,8,16,24,32,48,64],ut,Jo,Ss;function U(e,t){return e==="xsmall"?`@media(max-width:${J.breakpoints.small}px){${t}}`:`@media(min-width:${J.breakpoints[e]}px){${t}}`}function ft(e){return In(e).map(t=>{let n=J.breakpoints,r=t.contentRect.width,o="xsmall";for(let c in n){if(n[c]>r)return o;o=c}return o})}function Cs(e=""){return Object.entries(ui).map(([t,n])=>`:host([color=${t}]) ${e}{ ${n} }`).join("")}function dt(e,t,n=""){return ii(e,`
		${t?`:host ${n} { ${ui[t]} }`:""}
		:host${t?"":"([color])"} ${n} {
		...
		${Cs(n)}
	`)}function ii(e,t){let n=d(t);return y(e,{persist:It,render:r=>n(r)})}function ye(e,t){return ii(e,ws.map(n=>{let r=t(n);return n===0?`:host ${r}`:`:host([size="${n}"]) ${r}`}).join(""))}function ai(){let e=document.adoptedStyleSheets.indexOf(ut);e!==-1&&document.adoptedStyleSheets.splice(e,1)}function ks(e){ut&&ai();let t=e.globalCss??"";e.colors&&(t+=`:root{${ri(e.colors)}}`),t&&(ut=Le(t),document.adoptedStyleSheets.push(ut)),Dt.next({theme:e,stylesheet:ut,css:t}),Fn.next(e.name)}var Zo="";function si(e){e?e!==Zo&&(typeof e=="string"?import(e):e()).then(t=>ks(t.default)):ut&&(ai(),Dt.next(void 0),Fn.next("")),Zo=e}function As(e){let t;return Dt.tap(n=>{let r=n?.theme.override?.[e.tagName];r?t?t.replace(r):e.shadowRoot?.adoptedStyleSheets.push(t??=Le(r)):t&&t.replace("")})}function Le(e){let t=new CSSStyleSheet;return e&&t.replaceSync(e),t}function ci(e,t=""){let n=Le(t);return z(e).adoptedStyleSheets.push(n),n}function d(e){let t;return n=>{let r=z(n);if(r.adoptedStyleSheets.push(t??=Le(e)),!n[On])return J.css&&r.adoptedStyleSheets.unshift(Ss??=Le(J.css)),n[On]=!0,As(n)}}var li=["background","primary","primary-container","secondary","secondary-container","tertiary","tertiary-container","surface","surface-container","surface-container-low","surface-container-lowest","surface-container-highest","surface-container-high","error","error-container","success","success-container","warning","warning-container","inverse-surface","inverse-primary"],fu=[...li,"inherit"];function Cr(e,t="surface"){return`--cxl-color-${t}: var(--cxl-color--${e});
...
`}function re(e){return`${Cr(e)};background-color:var(--cxl-color-surface);color:var(--cxl-color-on-surface);`}var ui=li.reduce((e,t)=>(e[t]=`
${Cr(t)}
${t==="inverse-surface"?Cr("inverse-primary","primary"):""}
...
`);function Mr(e){return h(e,"disabled").switchMap(t=>t?T:Nn(e).tap(n=>{n.stopPropagation(),e.click()}))}function Nr(e){return f(Mr(e),Fe(e))}var gt=class extends g{disabled=!1;touched=!1};u(gt,{init:[b("disabled"),b("touched")],augment:[G("button"),Nr]});var Ft=class extends gt{size;color;variant};u(Ft,{tagName:"c-button",init:[ye("size",e=>`{
			font-size: ${14+e*4}px;
...
`),t=>V(t,"open").tap(n=>{n||t.dispatchEvent(new Event("close"))})]})}};var Rr=class{currentPopupContainer;currentPopup;currentModal;currentTooltip;popupContainer=document.body;toggle(t){t.element.parentElement!==this.popupContainer?this.popupOpened(t):t.close()}popupOpened(t){this.currentPopup&&t.element!==this.currentPopup.element&&this.currentPopup.close(),this.currentPopup=t}openModal(t){this.currentModal&&t.element!==this.currentModal.element&&this.currentModal.close(),t.element.parentNode||this.popupContainer?.append(t.element),t.element.open||t.element.showModal(),this.currentModal=t}closeModal(){this.currentModal?.close(),this.modalClosed()}modalClosed(){this.currentModal=void 0}tooltipOpened(t){this.currentTooltip&&this.currentTooltip!==t&&this.currentTooltip.remove(),this.currentTooltip=t}close(){this.currentPopup?.close()}},Pe=new Rr;function vi(e=document){document.documentElement.lang="en";let t=[N("meta",{name:"viewport",content:"width=device-width, initial-scale=1"}),N("meta",{name:"apple-mobile-web-app-capable",content:"yes"}),N("meta",{name:"mobile-web-app-capable",content:"yes"}),N("style",void 0,`html{height:100%;}html,body{padding:0;margin:0;min-height:100%;${B("body-large")}}
			a{color:var(--cxl-color-on-surface)}
			`)];return e.head.append(...t),t}function wi(e=2e3){return f(Ge(e),Bn()).first()}function Ei(e){return wi().raf(()=>e.setAttribute("ready",""))}function jn(e){return f(K(t=>{let n=vi(e.ownerDocument??document);t.signal.subscribe(()=>n.forEach(r=>r.remove()))}),Ne().raf(()=>{let t=e.firstElementChild;t instanceof HTMLTemplateElement&&(e.append(t.content),t.remove())}),wi().switchMap(()=>ft(e).raf(t=>e.setAttribute("breakpoint",t))),Ei(e),Fn.raf(t=>t?e.setAttribute("theme",t):e.removeAttribute("theme")))}var _r=class extends g{connectedCallback(){requestAnimationFrame(()=>vi(this.ownerDocument||document)),super.connectedCallback()}};u(_r,{tagName:"c-meta",augment:[()=>Ei(document.body)]});function Si(e,t,n){n==="in"&&(e.style.display="");let r=e.offsetWidth,o=Re({target:e,animation:{kf:{[t]:n==="in"?[`-${r}px`,"0"]:["0",`-${r}px`]}}});n==="out"&&(o.onfinish=()=>e.style.display="none")}var Bt=class extends g{sheetstart=!1;sheetend=!1};u(Bt,{tagName:"c-application",init:[b("sheetstart"),b("sheetend")],augment:[d(`
:host {
	display: flex;
	position: absolute;
	inset: 0;
...
:host {
	...
	`),I,e=>(e.slot||="help",h(e,"invalid").tap(t=>{e.ariaLive??=t?"assertive":"polite"}))]});var Br=d(`
:host {
  display: block;
  position: relative;
  text-align: start;
...
:host(:focus-visible) { background-image: linear-gradient(0, var(--cxl-mask-focus),var(--cxl-mask-focus)) }
		`),I]});var zr=class extends Gn{open=!1;optionView=bt;setSelected(t){if(super.setSelected(t),this.open)this.open=!1;else{for(let n of this.options)n!==t&&(n.slot="");t&&(t.slot="selected")}}};u(zr,{tagName:"c-select",init:[b("open")],augment:[G("listbox"),d(`
...
`);function Mc(e){return f(Be("list",e),h(e,"selected").tap(t=>e.ariaSelected=String(t)))}function Yr(e){return f(Mr(e),Fe(e,e,-1),Mc(e))}var wt=class extends g{disabled=!1;touched=!1;selected=!1};u(wt,{init:[b("disabled"),b("touched"),b("selected")],augment:[Yr]});var Gr=class extends wt{size};u(Gr,{tagName:"c-item",init:[ye("size",e=>`{min-height:${56+e*8}px}`)],augment:[Ac,be,Pn,G("option"),I,ve]});var Wt=class extends Yt{disabled=!1;touched=!1;selected=!1};u(Wt,{tagName:"c-card-item",init:[b("disabled"),b("touched"),b("selected")],augment:[G("option"),...Je,d(`
:host([variant=outlined]:hover) { box-shadow: var(--cxl-elevation-1) }
:host([variant=elevated]) { color: var(--cxl-color-on-surface); }
		`),Yr,ve]});var qt=class extends g{disabled=!1;touched=!1;selected=!1;color;size=0};u(qt,{tagName:"c-chip",init:[b("disabled"),b("touched"),b("selected"),dt("color","surface-container-low"),ye("size",e=>`{
			padding: 2px ${e<0?2:8}px;
			font-size: ${14+e*2}px;
			height: ${32+e*6}px;
		}`)],augment:[G("button"),Nr,...Je,d(`
:host {
	box-sizing: border-box;
	border: 1px solid var(--cxl-color-outline-variant);
...
:host([center]) {
  ...
  align-items: center;
	...
	`),e=>S(e,"keydown").tap(t=>t.stopPropagation()),I]});var Vi=d(":host(:not([open],[motion-out-on])){display:none}");function Jr(e,t=()=>e,n=!1){let r=Q(()=>F(t("in"))),o=Q(()=>F(t("out")));return f(pe(e,"toggle.close").tap(()=>e.open=!1).ignoreElements(),oe(h(e,"motion-in").map(c=>c?r.switchMap(i=>qr(e,i,c,"in")).switchMap(()=>e.duration!==void 0&&e.duration!==1/0?Ge(e.duration).map(()=>e.open=!1):T):r),h(e,"motion-out").map(c=>(c?o.switchMap(i=>qr(e,i,c,"out").ignoreElements()):o).finalize(()=>{e.open||e.dispatchEvent(new Event("close"))}))).switchMap(([c,i])=>V(e,"open").switchMap(s=>{if(e.popover!=="auto"){let a=s?"open":"closed";e.dispatchEvent(new ToggleEvent("toggle",{oldState:s?"closed":"open",newState:a}))}return s?n?ke(i,c):c:n?ke(i,c):i})))}var Et=class extends g{open=!1;duration;"motion-in";"motion-out"};u(Et,{init:[y("motion-in"),y("motion-out"),Ln("duration"),b("open")]});var Xr=class extends Et{};u(Xr,{tagName:"c-toggle-target",augment:[d(`
:host{display:contents}
`),e=>{let t=N("slot"),n=N("slot",{name:"off"});return(e.open?n:t).style.display="none",z(e).append(t,n),Jr(e,r=>{t.style.display=n.style.display="none";let o=e.open?r==="in"?t:n:r==="in"?n:t;return o.style.display="",o.assignedElements()},!0)}]});var Zt=class extends Et{};u(Zt,{tagName:"c-toggle-panel",augment:[I,Vi,Jr]});var Ic=d(`
#drawer {
	box-sizing: border-box;
    background-color: var(--cxl-color-surface);
    color: var(--cxl-color-on-surface);
...
`),Qn=class extends g{open=!1;position;responsive;permanent=!1};u(Qn,{tagName:"c-drawer",init:[b("open"),b("position"),y("responsive"),y("permanent")],augment:[Ic,d(`
...
.content { padding: 4px 12px; }
		`)]});var tt=class extends vt{vflex=!1;gap;middle=!1};u(tt,{tagName:"c-flex",init:[b("vflex"),b("gap"),b("middle")],augment:[Vr("flex"),Ur,d(`
...
${Xe.map(e=>`:host([gap="${e}"]){gap:${e}px}`).join("")}
	`),I]});function Oc(e){return Vn("list",e,e.items)}function Ui(e){return Oi({host:e,getFocusable:()=>e.items,getSelected:()=>e.items.find(t=>t.selected),getActive:()=>e.items.find(t=>t.matches(":focus,:focus-within")),observe:Oc(e)})}function Gi(e){return Li({getFocusable:()=>e.items,getActive:()=>Lr(e)})}function Lc(e){let t=Gi(e);function n(r){return Math.round(r.getBoundingClientRect().left)}return f(Ui(e),Ht({host:e,goRight:()=>t(1),goLeft:()=>t(-1),goFirst:()=>t(1,-1),goLast:()=>t(-1,e.items.length),goUp:()=>{let r=We(e)?.activeElement,o=r&&n(r);return t(-1,void 0,o!==void 0?c=>n(c)!==o:void 0)},goDown:()=>{let r=We(e)?.activeElement,o=r&&n(r);return t(1,void 0,o!==void 0?c=>n(c)!==o:void 0)}}).tap(r=>r.focus()))}var Qt=class extends g{items=[]};u(Qt,{tagName:"c-grid-list",augment:[G("grid"),d(":host{display:grid;box-sizing:border-box;}"),I,Lc]});var er=class extends g{pad;vertical=!1};u(er,{tagName:"c-hr",init:[b("pad"),b("vertical")],augment:[G("separator"),d(`
:host {
	display: block;
	height: 1px;
...
${Xe.map(e=>`:host([pad="${e}"]){margin:${e}px 0;}`).join("")}`)]});function Qr(e){let t=document.createElement("style");return f(K(n=>{let r=e.persistkey&&Ir.get(e.persistkey);r!==void 0?e.open=r===e.themeon:e.usepreferred&&(e.open=matchMedia?.("(prefers-color-scheme: dark)").matches),n.signal.subscribe(()=>t.remove())}),Oe(e).raf(()=>{e.setAttribute("aria-pressed",String(e.open));let n=e.open?e.themeon:e.themeoff;e.persistkey&&Ir.set(e.persistkey,n),si(oi[n]||n)}),q(e).tap(()=>e.open=!e.open))}var Zr=class extends g{open=!1;usepreferred=!1;persistkey="";themeoff="";themeon="./theme-dark.js"};u(Zr,{tagName:"c-toggle-theme",init:[y("persistkey"),y("usepreferred"),y("open"),y("themeon"),y("themeoff")],augment:[G("group"),Qr]});var Kt=class extends se{open=!1;usepreferred=!1;persistkey="";iconon="wb_sunny";iconoff="dark_mode";themeoff="";themeon="./theme-dark.js"};u(Kt,{tagName:"c-icon-toggle-theme",init:[y("persistkey"),y("usepreferred"),y("open"),y("themeon"),y("themeoff")],augment:[Qr,e=>oe(h(e,"iconon"),h(e,"iconoff"),h(e,"open")).tap(()=>e.icon=e.open?e.iconon:e.iconoff)]});var Fc=()=>{let e;function t(){let n=document.adoptedStyleSheets.indexOf(e);n!==-1&&document.adoptedStyleSheets.splice(n,1)}addEventListener("message",n=>{let{theme:r}=n.data;t(),r!==void 0&&(e=new CSSStyleSheet,e.replace(r),document.adoptedStyleSheets.push(e))})},Pc=()=>{let e=()=>{let t=()=>{parent.postMessage({height:document.documentElement.scrollHeight},"*")};requestAnimationFrame(async()=>{await document.fonts.ready,new ResizeObserver(t).observe(document.documentElement)})};document.readyState==="complete"?e():addEventListener("load",e)},en=class extends g{src="";srcdoc="";sandbox="allow-forms allow-scripts";reset="<!DOCTYPE html><style>html{display:flex;flex-direction:column;font:var(--cxl-font-default);}body{padding:0;margin:0;translate:0;overflow:auto;}</style>";handletheme=!0};u(en,{tagName:"c-iframe",init:[y("src"),y("srcdoc"),y("sandbox"),y("handletheme")],augment:[d(`
:host {
  position: relative;
  display: flex;
  flex-direction: column;
...
${U("xlarge",':host([xl]){display:contents}:host([xl="0"]){display:none}')}
	`),I]});var zc=/([^&=]+)=?([^&]*)/g,Hc=/:([\w_$@]+)/g,$c=/\/\((.*?)\)/g,jc=/(\(\?)?:\w+/g,Vc=/\*\w+/g,Uc=/[-{}[\]+?.,\\^$|#\s]/g,Gc=/([^#]*)(?:#(.+))?/,io="@@cxlRoute",fe={location:window.location,history:window.history};function Yc(e){let t=[];return[new RegExp("^/?"+e.replace(Uc,"\\$&").replace($c,"\\/?(?:$1)?").replace(jc,function(r,o){return t.push(r.substr(1)),o?r:"([^/?]*)"}).replace(Vc,"([^?]*?)")+"(?:/$|\\?|$)"),t]}function Wi(e){return e[0]==="/"&&(e=e.slice(1)),e.endsWith("/")&&(e=e.slice(0,-1)),e}function Kr(e,t){return t?e.replace(Hc,(n,r)=>t[r]||""):e}function Wc(e){let t={},n;for(;n=zc.exec(e);)t[n[1]]=decodeURIComponent(n[2]);return t}var eo=class{path;regex;parameters;constructor(t){this.path=t=Wi(t),[this.regex,this.parameters]=Yc(t)}_extractQuery(t){let n=t.indexOf("?");return n===-1?{}:Wc(t.slice(n+1))}getArguments(t){let n=this.regex.exec(t),r=n&&n.slice(1);if(!r)return;let o=this._extractQuery(t);return r.forEach((c,i)=>{let s=i===r.length-1?c||"":c?decodeURIComponent(c):"";o[this.parameters[i]]=s}),o}test(t){return this.regex.test(t)}toString(){return this.path}},to=class{id;path;parent;redirectTo;definition;isDefault;constructor(t){if(t.path!==void 0)this.path=new eo(t.path);else if(!t.id)throw console.log(t),new Error("An id or path is mandatory. You need at least one to define a valid route.");this.id=t.id||(t.path??`route${Math.random().toString()}`),this.isDefault=t.isDefault||!1,this.parent=t.parent,this.redirectTo=t.redirectTo,this.definition=t}create(t){let n=this.definition.render();n[io]=this;for(let r in t)t[r]!==void 0&&(n[r]=t[r]);return n}},no=class{routes=[];defaultRoute;findRoute(t){return this.routes.find(n=>n.path?.test(t))??this.defaultRoute}get(t){return this.routes.find(n=>n.id===t)}register(t){if(t.isDefault){if(this.defaultRoute)throw new Error("Default route already defined");this.defaultRoute=t}this.routes.unshift(t)}};function qc(e){return e[io]}function St(e){let t=Gc.exec(e);return{path:Wi(t?.[1]||""),hash:t?.[2]||""}}var Xc={getHref(e){return e=typeof e=="string"?St(e):e,`${fe.location.pathname}${e.path?`?${e.path}`:""}${e.hash?`#${e.hash}`:""}`},serialize(e){let t=fe.history.state?.url;if(!t||e.hash!==t.hash||e.path!==t.path){let n=this.getHref(e);n!==`${location.pathname}${location.search}${location.hash}`&&fe.history.pushState({url:e},"",n)}},deserialize(){return{path:fe.location.search.slice(1),hash:fe.location.hash.slice(1)}}},Jc={getHref(e){return e=typeof e=="string"?St(e):e,`${e.path}${e.hash?`#${e.hash}`:""}`},serialize(e){let t=fe.history.state?.url;if(!t||e.hash!==t.hash||e.path!==t.path){let n=this.getHref(e);n!==`${location.pathname}${location.search}${location.hash}`&&fe.history.pushState({url:e},"",n||"/")}},deserialize(){return{path:fe.location.pathname,hash:fe.location.hash.slice(1)}}},qi={getHref(e){return e=typeof e=="string"?St(e):e,`#${e.path}${e.hash?`#${e.hash}`:""}`},serialize(e){let t=qi.getHref(e);fe.location.hash!==t&&(fe.location.hash=t)},deserialize(){return St(fe.location.hash.slice(1))}},Xi={hash:qi,path:Jc,query:Xc},ro=class{callbackFn;state;routes=new no;instances={};root;lastGo;constructor(t){this.callbackFn=t}getState(){if(!this.state)throw new Error("Invalid router state");return this.state}route(t){let n=new to(t);return this.routes.register(n),n}go(t){this.lastGo=t;let n=typeof t=="string"?St(t):t,r=n.path,o=this.state?.url;if(r!==o?.path){let c=this.routes.findRoute(r);if(!c)throw new Error(`Path: "${r}" not found`);let i=c.path?.getArguments(r);if(c.redirectTo)return this.go(Kr(c.redirectTo,i));let s=this.execute(c,i);if(this.lastGo!==t)return;if(!this.root)throw new Error(`Route: "${r}" could not be created`);this.updateState({url:n,arguments:i,route:c,current:s,root:this.root})}else this.state&&n.hash!=o?.hash&&this.updateState({...this.state,url:n})}getPath(t,n){let r=this.routes.get(t),o=r&&r.path;return o&&Kr(o.toString(),n)}isActiveUrl(t){let n=St(t);if(!this.state?.url)return!1;let r=this.state.url;return!!Object.values(this.instances).find(o=>{let c=o[io],i=this.state?.arguments;if(c?.path?.test(n.path)&&(!n.hash||n.hash===r.hash)){if(i){let s=c.path.getArguments(n.path);for(let a in s)if(i[a]!=s[a])return!1}return!0}return!1})}updateState(t){this.state=t,this.callbackFn?.(t)}findRoute(t,n){let r=this.instances[t],o;if(r)for(o in n){let c=n[o];c!==void 0&&(r[o]=c)}return r}executeRoute(t,n,r){let o=t.parent,c=o&&this.routes.get(o),i=t.id,s=c&&this.executeRoute(c,n,r),a=this.findRoute(i,n)||t.create(n);return s?a&&a.parentNode!==s&&s.appendChild(a):this.root=a,r[i]=a,a}discardOldRoutes(t){let n=this.instances;for(let r in n){let o=n[r];t[r]!==o&&(o.parentNode?.removeChild(o),delete n[r])}}execute(t,n){let r={},o=this.executeRoute(t,n||{},r);return this.discardOldRoutes(r),this.instances=r,o}},on=new at,Ji=new at,Ee=new ro(()=>on.next());function Zc(e,t=Xi.query){return f(K(()=>Ji.next(t)),e.tap(()=>Ee.go(t.deserialize())),on.tap(()=>t.serialize(Ee.getState().url))).catchError(n=>{if(n?.name==="SecurityError")return T;throw n})}function Qc(){return ke(F(location.hash.slice(1)),S(window,"hashchange").map(()=>location.hash.slice(1)))}var rr;function Kc(){if(!rr){rr=new Nt(history.state);let e=history.pushState;history.pushState=function(...t){let n=e.apply(this,t);return history.state&&(history.state.lastAction="push"),rr.next(history.state),n}}return f(S(window,"popstate").map(()=>(history.state&&(history.state.lastAction="pop"),history.state)),rr)}function el(){let e;return f(Qc(),Kc()).map(()=>window.location).filter(t=>{let n=t.href!==e;return e=t.href,n})}var Yg=on.raf().map(()=>{let e=[],t=Ee.getState(),n=t.current;do n.routeTitle&&e.unshift({title:n.routeTitle,first:n===t.current,path:tl(n)});while(n=n.parentNode);return e});function tl(e){let t=qc(e);return t&&Kr(t.path?.toString()||"",Ee.state?.arguments||{})}function Zi(e,t,n=t){return f(oe(Ji,Oe(e)).tap(([r])=>{e.href!==void 0&&(t.href=e.external?e.href:r.getHref(e.href)),t.target=e.target||""}),q(t).tap(r=>{e.target||r.preventDefault()}),q(n).tap(()=>{e.href!==void 0&&!e.target&&(e.external?location.assign(e.href):Ee.go(e.href))}))}function nl(e,t){let n=document.createElement("div");return n.style.display="contents",n.routeTitle=t,n.appendChild(e.content.cloneNode(!0)),n}var oo=class extends g{strategy="query";get state(){return Ee.state}go(t){return Ee.go(t)}};u(oo,{tagName:"c-router",init:[y("strategy")],augment:[e=>{function t(n){let r=n.dataset;if(r.registered)return;r.registered="true";let o=r.title||void 0;Ee.route({path:r.path,id:r.id||void 0,parent:r.parent||void 0,isDefault:n.hasAttribute("data-default"),redirectTo:r.redirectto,render:nl.bind(null,n,o)})}return Ne().switchMap(()=>{for(let n of Array.from(e.children))n instanceof HTMLTemplateElement&&t(n);return f(An(e).tap(n=>{n.type==="added"&&n.value instanceof HTMLTemplateElement&&t(n.value)}),h(e,"strategy").switchMap(n=>{let r=Xi[n];return Zc(el(),r).catchError((o,c)=>(console.error(o),c))}))})}]});function so(e,t=e){return f(rl(e,t).ignoreElements(),on.map(()=>e.href!==void 0&&Ee.isActiveUrl(e.href)))}function rl(e,t=e){let n=N("a",{tabIndex:-1,className:"link",ariaLabel:"link"});return n.style.cssText=`
...
bottom: 0;
top: 0;
	`,z(e).append(n),f(Zi(e,n),S(n,"click").tap(r=>{r.stopPropagation(),_t(r)||e.dispatchEvent(new PointerEvent(r.type,r)),le(e,"toggle.close",void 0)}),q(t).tap(r=>{_t(r)&&n.click()}))}var ao=class extends g{href};u(ao,{tagName:"c-router-selectable",init:[y("href")],augment:[pt,()=>N("slot"),e=>Q(()=>{let t=e.parentElement;return so(e,t).raf(n=>{t.selected=n})})]});var an=class extends nt{href;external=!1;target};u(an,{tagName:"c-router-item",init:[y("href"),y("external"),y("target")],augment:[e=>so(e).tap(t=>{e.selected=t})]});var Se=class extends g{font};u(Se,{tagName:"c-t",init:[b("font")],augment:[d(`:host{display:inline-block;font:var(--cxl-font-body-medium);}${ei.map(e=>`:host([font="${e}"]){font:var(--cxl-font-${e});letter-spacing:var(--cxl-letter-spacing-${e})}`).join("")}
...
${U("medium",":host{padding:16px}")}
		`),()=>E("slot")]});var uo=class extends g{formatter=t=>'<link rel="stylesheet" href="hljs.css" /><code style="white-space:pre;min-height:100%;font:var(--cxl-font-code);tab-size:2;">'+hljs.highlight(t,{language:"html"}).value+"</code>"};u(uo,{tagName:"doc-hl",augment:[d(`
:host { display: block; }
.hljs { white-space: pre-wrap; font: var(--cxl-font-code); padding:16px; }
	`),e=>{let t=E("div",{className:"hljs"});return t.style.tabSize="4",z(e).append(t),Ne().switchMap(()=>_n(e).raf(()=>{let n=e.childNodes[0]?.textContent?.trim()||"";n&&e.formatter&&(n=e.formatter(n)),t.innerHTML=n}))}]});var po=class extends g{};u(po,{tagName:"doc-grd",augment:[d(`:host {
	padding: 8px 16px;
	display: grid;
	gap: 16px 12px;
}
...
`),I]});var ln=class extends g{summary;selected};u(ln,{tagName:"doc-nav-list",init:[X("summary"),X("selected")],augment:[e=>Ke({source:h(e,"summary").map(t=>t?.index),render:t=>E(nt,{$:n=>q(n).tap(()=>e.selected=t.value.name),size:-2},t.value.name,t.value.docs?.beta?E(qt,{size:-2},"beta"):void 0)})(e)]});var un=class extends g{view="mobile";header="<style>html{overflow:hidden;color: var(--cxl-color-on-background);background-color:var(--cxl-color-background)}</style>";libraries;formatter;getLibraryUrl(t){return`https://cdn.jsdelivr.net/npm/${t}`}};u(un,{tagName:"doc-demo-bare",init:[y("view"),y("libraries"),y("header")],augment:[d(`
  :host {
    display: flex;
    flex-direction: column;
    border: 1px solid var(--cxl-color-outline-variant);
  ...
  #toolbar {
	...
	`),e=>{let t=h(e,"view"),n=ie("container"),r=E(en,{className:n}),o=E(lt,{$:m=>Me(m).tap(()=>{e.formatter?m.innerHTML=e.formatter(a):m.innerText=a}),className:t.map(m=>m==="source"?"source visible hljs":"source")}),c=E(Gt,{$:m=>q(m).tap(()=>e.view="source"),className:h(e,"view").map(m=>m==="source"?"hide":""),title:"See source"},E(ue,{name:"code"}),"Code"),i=E(se,{$:m=>q(m).tap(()=>e.view="mobile"),height:20,className:h(e,"view").map(m=>m==="source"?"":"hide"),icon:"close",title:"Close source"}),s=E("div",{id:"toolbar"},E("slot",{name:"toolbar"}),E(se,{$:m=>q(m).tap(async()=>{await navigator.clipboard.writeText(a),m.icon="done",setTimeout(()=>m.icon="content_copy",2e3)}),height:20,icon:"content_copy",title:"Copy source to clipboard",className:t.map(m=>m==="source"?"icon":"icon hide")}),c,i),a;function l(m){let P=m==="desktop";n.next(P?"container":"container cmobile")}function C(){let m=e.childNodes[0]?.textContent?.trim()||"";if(!m)return;let P=e.libraries?e.libraries.split(",").map(R=>`<script type="module" src="${e.getLibraryUrl(R)}"><\/script>`).join(""):"";r.srcdoc=`${e.header}${P}${m}`,a=m}return z(e).append(s,E(lt,{className:t.map(m=>m==="source"?"parent":`parent visible ${m}`)},r),o),f(h(e,"view").tap(l),Me(e).switchMap(()=>_n(e).raf(C)))}]});var pn=class extends un{header=this.getHeader();hljsCss="hljs.css";formatter=t=>`<link rel="stylesheet" href="${this.hljsCss}" />`+hljs.highlight(t,{language:"html"}).value;getHeader(){let t="<style>html{overflow:hidden;color: var(--cxl-color-on-background);background-color:var(--cxl-color-background)}</style>";return typeof CONFIG<"u"?t+`${CONFIG.demoStyles?`<style>${CONFIG.demoStyles}</style>`:""}${CONFIG.demoScripts?.map(n=>`<script type="module" src="${n}"><\/script>`).join("")??""}`:t}};u(pn,{tagName:"doc-demo"});function Ki(e){let t=e.index;function n(s){if(!(!s||typeof s=="string")&&typeof s=="number")return t.find(a=>a.id===s)}function r(s){if(!(!s||typeof s=="string")){if(typeof s=="number"){let a=t.find(l=>l.id===s);return a&&(a.kind===4||a.kind===8)?a:a?r(a.resolvedType??a.type):void 0}return s.kind===6?n(s.type):s.resolvedType&&typeof s.resolvedType!="string"?s.resolvedType:s}}function o(s,a){if(s.children){for(let l of s.children)!l.name||l.flags&&l.flags&128||(a[l.name]??=l);return a}}function c(s,a={}){o(s,a);let l=r(s.type);if(l?.children)for(let C of l.children){let m=r(C);if(!m||m.kind!==35||m.name==="Component")break;c(m,a)}return a}function i(s){return s.kind===17||s.kind===16||s.kind===11||s.kind===13}return{getNodeProperties:c,getTypeSummary:r,isFunction:i,getRef:n,json:e}}var il={31:"Constants",1:"Variables",4:"Interfaces",8:"Classes",10:"Properties",11:"Methods",12:"Getters",13:"Setters",14:"Constructor",16:"Functions",22:"Enums",35:"Components",36:"Attributes",2:"Type Alias",38:"Call Signature",39:"Construct Signature",44:"Events",24:"Index Signature",25:"Exports",37:"Namespaces"};function ea(e){return typeof e=="string"?e:e.map(t=>t.value).join(" ")}function al(e){return e.name?`docs/ui-${e.name}`:void 0}function sl(e){let t=al(e),n=e.name??"?";return t?E("a",{href:t},n):n}function ta({summary:e,summaryJson:t,link:n=sl,uiCdn:r,importmap:o,codeHighlight:c}){let{getTypeSummary:i,getRef:s,isFunction:a}=Ki(t),l=t.index;function C(w){if(w)return typeof w=="string"?w:i(w)??(typeof w=="number"?void 0:w.name)}function m(w){return w?"&lt;"+w.map(k=>R(k)+(k.kind!==6&&k.type?` extends ${R(k.type)}`:"")).join(", ")+"&gt;":""}function P(w){return["{ ",...w.children?.map($e).flatMap(At("; "))??[]," }"]}function R(w){let k=C(w);if(!k||typeof k=="string")return[k||"?"];switch(k.kind){case 5:return k.children?.map(R).flatMap(At(" | "))??[];case 23:case 32:return[k.name??"?"];case 34:return P(k)??["?"];case 15:return[...R(k.type),"[]"];case 4:case 8:case 35:{let p=k.typeP?m(k.typeP):void 0;return[n(k),p]}case 17:return $e(k);case 33:{let p=s(w);return[p?n(p):k.name??"?"]}case 21:return[...R(k.children?.[0]),"[",...R(k.children?.[1]),"]"];default:console.log(k)}return[]}function $(w){let k=w.flags??0;return[`${`${k&4?"public ":k&8?"private":k&16?"protected ":""}${k&262144?"...":""}${w.name}${k&524288?"?":""}`}: `,...R(w.type)]}function W(w){return["(",...w?.map($).flatMap(At(", "))??[],")"]}function ae(w){let k=w.flags??0,p=w.kind===12?"get ":w.kind===13?"set ":void 0;return[k&32?"static ":"",k&64?"readonly ":"",k&128?"abstract ":"",p]}function te(w){return["[",...w.parameters?.flatMap($e)??[]??[],"]: ",...w.type?R(w.type)??[]:["?"]]}function At(w){return(k,p)=>p!==0?[...w,...k]:k}function $e(w){if(w.kind===24)return te(w);if(w.kind===45&&w.children?.[0])return["...",...R(w.children[0])];let k=w.flags&&w.flags&524288,p=a(w)?W(w.parameters):[],x=w.kind===17;return[...ae(w),w.name,k?"?":"",...p,x?" => ":": ",...R(w.resolvedType??w.type)]}function it(w){return[E("h3",{},E(Se,{font:"title-large"},...$e(w))),...Mt(w)]}function gn(w,k){if(!w.children)return[];let p={};for(let x of w.children)x.kind!==14&&x.kind!==0&&(x.flags||0)&4&&!k?.(x)&&(p[x.kind]??={name:il[x.kind],nodes:[]}).nodes.push(x);return Object.values(p).sort(ki("name")).flatMap(x=>[E("h2",{},x.name),...x.nodes.flatMap(it)])}function cr(w){let k;w=w.replace(/<caption>(.+?)<\/caption>/,(O,Y)=>(k=Y,""));let p=`<style>body{display:flex;align-items:center;flex-wrap:wrap;justify-content:center;overflow-x:hidden;overflow-y:auto;padding:0 24px 24px 24px;gap:32px;min-height:96px;color:var(--cxl-color-on-background);
background-color:var(--cxl-color-background)}</style>`,x=(o??"")+`<script type="module" src="${r}"><\/script>`,A=E(pn,{header:p+x,formatter:c},w);return[k?E(Se,{font:"title-medium"},k):void 0,A]}function lr(w){return l.find(k=>k.name===w)}function me(w){let k=w.flatMap(p=>{let x=p.value,A=ea(x);if(typeof x=="string"){let O=lr(x);A=O?n(O):x}return[A,", "]});return k.pop(),E("p",{},"Related: ",k)}function hn({src:w}){let k=E("div");return k.textContent=w,k}function Mt(w){let k=w.docs;if(!k||!k.content)return[];let p=[],x=k.content.flatMap(A=>{let O=ea(A.value);return A.tag==="icon"||A.tag==="title"?[]:A.tag==="example"||A.tag==="demo"||A.tag==="demoonly"?cr(O):A.tag==="see"?(p.push(A),[]):A.tag==="return"?[E(Se,{font:"headline-small"},"Returns"),E("p",void 0,O)]:A.tag==="param"?[E("p",void 0,O)]:[A.tag?E("p",void 0,`${A.tag}: `,O):hn({src:O})]});return p.length&&x.push(me(p)),x}function ur(w){let k=[],p=i(w);if(!(!p||p.kind!==33))return p.children?.forEach(x=>{if(typeof x!="object")return;let A=i(x);A&&A.name!=="Component"&&k.push(n(A))}),E(Se,{font:"headline-small"}," ",...k.length?["extends ",k]:[])}function xn(w){let k=i(w.type),p=[];if(!k?.children)return[];for(let x of k.children){let A=i(x);if(!A||A.kind!==35||A.name==="Component")break;let O=gn(A,Y=>!!((Y.flags??0)&128));O.length&&p.push(E("br"),E(Se,{font:"h6"},"Inherited from ",n(A)),...O),p.push(...xn(A))}return p}let bn=e.kind===35&&e.docs?.tagName;return E("div",{},E("h1",{},e.name," ",e.type&&ur(e.type)," ",bn?E(Se,{font:"title-medium"},`<${bn}>`):""),...Mt(e),...gn(e),...xn(e))}var fn=class extends g{name;summary;uicdn;importmap=""};u(fn,{tagName:"doc-page",init:[X("name"),X("summary"),X("uicdn")],augment:[e=>Oe(e).raf(()=>{if(e.replaceChildren(),!e.name||!e.summary)return;let t=e.name,n=e.summary.index.find(r=>r.name===t);n&&e.append(ta({summary:n,summaryJson:e.summary,uiCdn:e.uicdn??"",importmap:e.importmap}))})]});var fo=class extends Bt{summary;sheetstart=!0};u(fo,{tagName:"doc-root",augment:[e=>{let t=Ye();fetch("summary.json").then(r=>r.json()).then(r=>t.next(r));let n=E(ln,{slot:"start",summary:t});e.append(n,E(fn,{summary:t,name:h(n,"selected")}))}]});var mo=class extends an{};u(mo,{tagName:"doc-item"});var go=class extends g{};u(go,{tagName:"doc-search-page",augment:[d(`
